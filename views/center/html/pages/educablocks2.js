/*! Educablocks2 - v0.2.3 - 2016-02-02
 * https://github.com/bq/Educablocks2
...
(function(factory) {
    ...
    var load = function(options) {
        // Source: src/lang.js
        /* global Educablocks2, options */
        Educablocks2.locales = {
            defaultLanguage: {},
            languages: []
        };
        Educablocks2.locales.getLang = function() {
            return this.defaultLanguage.lngCode;
        };
        Educablocks2.locales.getKey = function(key) {
            return this.defaultLanguage[key];
        };
        Educablocks2.locales.setDefaultLang = function(langCode) {
        ...
        Educablocks2.locales.add = function(langCode, values) {
            if (!langCode) {
        ...
        Educablocks2.locales.initialize = function() {
            var lang = options.lang || window.Educablocks2Language || 'es-ES';
        ...
        (function() {
            ...
            // Browser
            // if (typeof window !== 'undefined' && this.Educablocks2 && this.Educablocks2.locales.add) {
            //     this.Educablocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Educablocks2 && Educablocks2.locales.add) {
                Educablocks2.locales.add('es-ES', language);
            }
        }());
        ...
        /* global Educablocks2, Blockly*/
        Educablocks2.locales.initialize();
        Educablocks2.variables = {};
        Educablocks2.isVariable = function(varValue) {
            for (var i in Blockly.Variables.allVariables()) {
                if (Blockly.Variables.allVariables()[i] === varValue) {
                    return true;
                }
            }
            if (Educablocks2.variables[varValue] !== undefined) {
                return true;
            }
        ...
        Educablocks2.findPinMode = function(dropdown_pin) {
            var code = '';
        ...
        // RGB block colors
        Educablocks2.LANG_COLOUR_SALIDAS = '#f44336';
        Educablocks2.LANG_COLOUR_ENTRADAS = '#9C27B0';
        Educablocks2.LANG_COLOUR_SERVO = '#2196F3';
        Educablocks2.LANG_COLOUR_LCD = '#3F51B5';
        Educablocks2.LANG_COLOUR_CONTROL = '#FF1744';
        Educablocks2.LANG_COLOUR_LOGIC = '#009688';
        Educablocks2.LANG_COLOUR_MATH = '#00BCD4';
        Educablocks2.LANG_COLOUR_TEXT = '#4CAF50';
        Educablocks2.LANG_COLOUR_COMMUNICATION = '#00BFA5';
        Educablocks2.LANG_COLOUR_ADVANCED = '#FF9800';
        Educablocks2.LANG_COLOUR_VARIABLES = '#FF5722';
        Educablocks2.LANG_COLOUR_PROCEDURES = '#607D8B';
        Educablocks2.setColors = function(colorArray) {
            Educablocks2.LANG_COLOUR_SALIDAS = colorArray[0];
            Educablocks2.LANG_COLOUR_ENTRADAS = colorArray[1];
            Educablocks2.LANG_COLOUR_SERVO = colorArray[2];
            Educablocks2.LANG_COLOUR_LCD = colorArray[3];
            Educablocks2.LANG_COLOUR_CONTROL = colorArray[4];
            Educablocks2.LANG_COLOUR_LOGIC = colorArray[5];
            Educablocks2.LANG_COLOUR_MATH = colorArray[6];
            Educablocks2.LANG_COLOUR_TEXT = colorArray[7];
            Educablocks2.LANG_COLOUR_COMMUNICATION = colorArray[8];
            Educablocks2.LANG_COLOUR_ADVANCED = colorArray[9];
            Educablocks2.LANG_COLOUR_VARIABLES = colorArray[10];
            Educablocks2.LANG_COLOUR_PROCEDURES = colorArray[11];
        };
...
this["JST"]["ESPERAR2"] = function(obj) {
        ...
        this["JST"]["REPOSO_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = 'servos[10].attach(10);\nservos[11].attach(11);\n ',
                __e = _.escape;
            with(obj) {
                __p +=''; 
            }
...
//coco final
        ...
        this["JST"]["ATRAS2_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
...
;
        ...
        /* global Blockly, JST, Educablocks2 */
        /* jshint sub:true */
        ...
        Blockly.Arduino.advanced_conversion = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(value_num);
            code += a['code'];
            value_num = a['pin'];
        ...
        Blockly.Blocks.advanced_conversion = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_COMMUNICATION'),
            helpUrl: Educablocks2.URL_SERIE,
            /**
             * advanced_conversion initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_CONVERT'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_DECIMAL') || 'DEC', 'DEC'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_HEXADECIMAL') || 'HEX', 'HEX'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_OCTAL') || 'OCT', 'OCT'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_BINARY') || 'BIN', 'BIN']
                    ]), 'CONV');
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_VALUE'))
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .setCheck(Number);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_CONVERSION_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.advanced_map = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(num);
            code += a['code'];
            num = a['pin'];

            a = Educablocks2.findPinMode(from_min);
            code += a['code'];
            from_min = a['pin'];

            a = Educablocks2.findPinMode(from_max);
            code += a['code'];
            from_max = a['pin'];

            a = Educablocks2.findPinMode(to_min);
            code += a['code'];
            to_min = a['pin'];

            a = Educablocks2.findPinMode(to_max);
            code += a['code'];
            to_max = a['pin'];
        ...
        Blockly.Blocks.advanced_map = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_MATH'),
            helpUrl: Educablocks2.URL_MATH,
            /**
             * advanced_map initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_MATH);
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_MAP'))
                    .setCheck(Number);
                this.appendValueInput('FROM_MIN', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_FROM'))
                    .setCheck(Number);
                this.appendValueInput('FROM_MAX', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_HYPHEN'))
                    .setCheck(Number);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_BRACKET'));
                this.appendValueInput('TO_MIN', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_TO'))
                    .setCheck(Number);
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_MATH_ADVANCED_MAP_TOOLTIP'));
            }
        };

        // Source: src/blocks/array_get/array_get.js
        /* global Blockly, Educablocks2 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.array_get = {
            // Numeric value.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_VARIABLES'),
            helpUrl: Educablocks2.URL_VAR,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendDummyInput('DUMMY').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GET')).appendField(new Blockly.FieldVariable(' '), 'VAR');
                // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                this.appendDummyInput('DUMMY2').appendField(Educablocks2.locales.getKey('LANG_ARRAY_GET_BRACKET1')).appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.array_get.validator), 'INDEX').appendField(Educablocks2.locales.getKey('LANG_ARRAY_GET_BRACKET2'));
                this.setOutput(true, Number);
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ARRAY_GET_TOOLTIP'));
            },
            ...
            onchange: function() {
                ...
                for (var i in variables) {
                    if (Blockly.Variables.allVariables()[i] !== this.last_variables[i]) {
                        ...
                        this.appendDummyInput('DUMMY').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GET')).appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                        this.appendDummyInput('DUMMY2').appendField(Educablocks2.locales.getKey('LANG_ARRAY_GET_BRACKET1')).appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.array_get.validator), 'INDEX').appendField(Educablocks2.locales.getKey('LANG_ARRAY_GET_BRACKET2'));
                ...
                try {
                    if (!this.exists()) {
                        this.setWarningText(Educablocks2.locales.getKey('LANG_VARIABLES_CALL_WITHOUT_DEFINITION'));
                    } else {
        ...
        /* global Blockly, options, JST, Educablocks2 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Arduino.bq_bat = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(echo_pin);
            code += a['code'];
            echo_pin = a['pin'];

            a = Educablocks2.findPinMode(trigger_pin);
            code += a['code'];
            trigger_pin = a['pin'];
            ...
            if (Educablocks2.isVariable(echo_pin)) {
            ...
            if (Educablocks2.isVariable(trigger_pin)) {
        ...
        Blockly.Blocks.bq_bat = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_ZUM'),
            tags: ['bat'],
            helpUrl: Educablocks2.URL_US,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendDummyInput('').appendField(Educablocks2.locales.getKey('LANG_BQ_BAT')).appendField(new Blockly.FieldImage('img/blocks/bqmod09.png', 208 * options.zoom, 140 * options.zoom));
                this.appendValueInput('RED PIN').appendField(Educablocks2.locales.getKey('LANG_BQ_BAT_RED_PIN')).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT);
                this.appendValueInput('BLUE PIN').appendField(Educablocks2.locales.getKey('LANG_BQ_BAT_BLUE_PIN')).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT);
                this.setInputsInline(false);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BAT_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_bluetooth_def = function() {
            ...
            if (this.getFieldValue('TOGGLE') === 'FALSE') {
                ...
                var a = Educablocks2.findPinMode(dropdown_pin);
                Blockly.Arduino.setups_['setup_bluetooth_pinmode'] = a['code'];
                dropdown_pin = a['pin'];
                a = Educablocks2.findPinMode(NextPIN);
            ...
            var b = Educablocks2.findPinMode(baud_rate);
        ...
        Blockly.Blocks.bq_bluetooth_def = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_COMMUNICATION'),
            tags: ['bluetooth'],
            helpUrl: Educablocks2.URL_BT,
            /**
             * bq_bluetooth_slave initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_DEF')).appendField(new Blockly.FieldImage('img/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));
                this.appendValueInput('BAUD_RATE').setCheck(Number).appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_DEF_BAUD_RATE')).setAlign(Blockly.ALIGN_RIGHT);
                ...
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_DEF_TOOLTIP'));
            },
            checkBT: function() {
                if (this.getFieldValue('TOGGLE') === 'FALSE') {
                    try {
                    ...
                    this.appendValueInput('PIN').setCheck(Number).appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_DEF_PIN1')).setAlign(Blockly.ALIGN_RIGHT);
                    this.appendValueInput('PIN2').setCheck(Number).appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_DEF_PIN2')).setAlign(Blockly.ALIGN_RIGHT);
                } else {
                    try {
                        this.removeInput('PIN');
                        this.removeInput('PIN2');
        ...
        Blockly.Blocks.bq_bluetooth_receive = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_RECEIVE'));
                ...
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_RECEIVE_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_bluetooth_send = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(statement_send);
            code += a['code'];
        ...
        Blockly.Blocks.bq_bluetooth_send = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_SEND'));
                // .appendField(new Blockly.FieldImage('img/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));

                this.appendValueInput('SNT')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_SEND_SEND'));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BLUETOOTH_SEND_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_button = function() {
            ...
            if (Educablocks2.isVariable(dropdown_pin)) {
        ...
        Blockly.Blocks.bq_button = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_BQ'),
            tags: ['button'],
            helpUrl: Educablocks2.URL_BUTTON,
            /**
             * bq_button initialization
             **/
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_BQ);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTON')).appendField(new Blockly.FieldImage('img/blocks/bqmod05.png', 336 * options.zoom, 176 * options.zoom)).setCheck(Number).appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTON_PIN')).setAlign(Blockly.ALIGN_RIGHT);
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BUTTON_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.bq_buttons = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_BQ'),
            tags: ['buttons'],
            helpUrl: Educablocks2.URL_BUTTONS,
            /**
            ...
            init: function() {
                ...
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS'))
                    .appendField(new Blockly.FieldImage('img/blocks/bqmod10.png', 336 * options.zoom, 176 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_PIN'))
                    .setCheck(Number);
                this.appendStatementInput('BUTN1')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_BUTTON_A'));
                this.appendStatementInput('BUTN2')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_BUTTON_B'));
                this.appendStatementInput('BUTN3')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_BUTTON_C'));
                this.appendStatementInput('BUTN4')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_BUTTON_D'));
                this.appendStatementInput('BUTN5')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_BUTTON_E'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_BUTTONS_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.bq_infrared = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_BQ'),
            tags: ['infrared'],
            helpUrl: Educablocks2.URL_IR,
            /**
             * bq_infrared initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_BQ);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_BQ_INFRARED')).appendField(new Blockly.FieldImage('img/blocks/bqmod04.png', 208 * options.zoom, 126 * options.zoom)).appendField(Educablocks2.locales.getKey('LANG_BQ_INFRARED_PIN')).setCheck(Number);
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_INFRARED_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_joystick = function() {
            ...
            var a = Educablocks2.findPinMode(pinx);
            code += a['code'];
            pinx = a['pin'];

            a = Educablocks2.findPinMode(piny);
            code += a['code'];
            piny = a['pin'];

            a = Educablocks2.findPinMode(pinbutton);
            code += a['code'];
            pinbutton = a['pin'];
            ...
            if (Educablocks2.isVariable(pinbutton)) {
        ...
        Blockly.Blocks.bq_joystick = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_BQ'),
            tags: ['joystick'],
            helpUrl: Educablocks2.URL_JOYSTICK,
            /**
             * bq_joystick initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_BQ);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK')).appendField(new Blockly.FieldImage('img/blocks/bqmod11.png', 209 * options.zoom, 277 * options.zoom));
                // this.appendValueInput('POS')
                //     .appendField(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK_POSITION'))
                //     .setAlign(Blockly.ALIGN_RIGHT)
                //     .setCheck(Number);
                this.appendValueInput('PINX').appendField(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK_PIN_X')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.appendValueInput('PINY').appendField(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK_PIN_Y')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.appendValueInput('PINBUTTON').appendField(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK_PIN_BUTTON')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.setOutput(true, Number);
                // this.setPreviousStatement(true, null);
                // this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_JOYSTICK_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_led = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(dropdown_pin1);
            code += a['code'];
            dropdown_pin1 = a['pin'];
            if (Educablocks2.isVariable(dropdown_pin1)) {
        ...
        Blockly.Blocks.bq_led = {
            ...
            init: function() {
                ...
                this.setColour(Educablocks2.LANG_COLOUR_BQ);
                this.appendDummyInput('').appendField(Educablocks2.locales.getKey('LANG_BQ_LED')).appendField(new Blockly.FieldImage('img/blocks/bqmod02.png', 208 * options.zoom, 140 * options.zoom));
                this.appendValueInput('PIN1').appendField(Educablocks2.locales.getKey('LANG_BQ_LED_PIN1')).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT);
                this.appendValueInput('PIN2').appendField(Educablocks2.locales.getKey('LANG_BQ_LED_PIN2')).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_LED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.bq_photoresistor = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_BQ);
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_PHOTORESISTOR'))
                    .appendField(new Blockly.FieldImage('img/blocks/bqmod01.png', 208 * options.zoom, 140 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_BQ_PHOTORESISTOR_PIN'))
                    .setCheck(Number);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_BQ_PHOTORESISTOR_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.bq_piezo_buzzer = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(dropdown_pinrojo);
            code += a['code'];
            dropdown_pinrojo = a['pin'];

            var a = Educablocks2.findPinMode(dropdown_pinverde);
            code += a['code'];
            dropdown_pinverde = a['pin'];

            var a = Educablocks2.findPinMode(dropdown_pinazul);
            code += a['code'];
            dropdown_pinazul = a['pin'];

            var a = Educablocks2.findPinMode(delay_time);
            code += a['code'];
            delay_time = a['pin'];
           
            if (Educablocks2.isVariable(dropdown_pinrojo)) {
...
//nuevo setup
        ...
        Blockly.Blocks.controls_setup = {
            // Setup statements.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_CONTROLS'),
            // helpUrl: Educablocks2.URL_SETUP,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_CONTROL);
                this.appendStatementInput('SETUP').appendField(new Blockly.FieldImage('img/blocks/inicial1.png', 203 * options.zoom, 165 * options.zoom));
                this.setPreviousStatement(false);
                this.setNextStatement(false);
                this.setTooltip(Educablocks2.locales.getKey('LANG_CONTROLS_SETUP_LOOP_TOOLTIP'));
            }
        };
...
//fin nuevo setup
        ...
        Blockly.Arduino.controls_Loop = function() {
            // Add statements to setup.
            var branch = Blockly.Arduino.statementToCode(this, 'SETUP');
            branch = branch.replace(/&quot;/g, '"');
        ...
        Blockly.Blocks.controls_Loop = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_CONTROL);
                this.appendStatementInput('LOOP').appendField(new Blockly.FieldImage('img/blocks/inicial2.png', 203 * options.zoom, 165 * options.zoom));
                this.setPreviousStatement(false);
                this.setNextStatement(false);
                this.setTooltip(Educablocks2.locales.getKey('LANG_CONTROLS_SETUP_LOOP_TOOLTIP'));
            }
        ...
        Blockly.Blocks.inout_analog_read = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_ADVANCED'),
            helpUrl: Educablocks2.URL_PIN_FUNC,
            /**
             * inout_analog_read initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_READ'));
                this.setOutput(true, Number);
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.inout_analog_write = function() {
            ...
            var b = Educablocks2.findPinMode(value_num);
            code += b['code'];
            value_num = b['pin'];
        ...
        Blockly.Blocks.inout_analog_write = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE'));
                this.appendValueInput('NUM', Number).appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE_VALUE')).setCheck(Number);
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_builtin_led = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_BUILTIN_LED'))
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_BUILTIN_LED_STATE'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_ADVANCED_BUILTIN_LED_ON') || 'ON', 'HIGH'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_BUILTIN_LED_OFF') || 'OFF', 'LOW']
                    ]), 'STAT');
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_BUILTIN_LED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_digital_read = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_READ'));
                this.setOutput(true, Boolean);
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_digital_write = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE')).appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_PIN'));
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_STATE')).appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_HIGH') || 'HIGH', 'HIGH'],
                    [Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_LOW') || 'LOW', 'LOW']
                ]), 'STAT');
                this.setPreviousStatement(true, null);
                this.setInputsInline(true);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_highlow = {
            ...
            init: function() {
                ...
                this.appendDummyInput('')
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_ADVANCED_HIGHLOW_HIGH') || 'HIGH', 'HIGH'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_HIGHLOW_LOW') || 'LOW', 'LOW']
                    ]), 'BOOL');
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_HIGHLOW_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.lcd_clear = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_LCD'),
            tags: ['lcd'],
            helpUrl: Educablocks2.URL_LCD,
            /**
             * lcd_slave initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_LCD);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_LCD_CLEAR'));
                // .appendField(new Blockly.FieldImage('img/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_LCD_CLEAR_TOOLTIP'));
            }
        };

        // Source: src/blocks/lcd_def/lcd_def.js
        /* global Blockly, JST, options, Educablocks2 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.lcd_def = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_LCD);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_LCD_DEF')).appendField(new Blockly.FieldImage('img/blocks/lcd.png', 208 * options.zoom, 100 * options.zoom));
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_LCD_PINS'))
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_LCD_DEF_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.lcd_print = function() {
            ...
            var a = Educablocks2.findPinMode(xcoor);
            code += a['code'];
            xcoor = a['pin'];

            a = Educablocks2.findPinMode(ycoor);
            code += a['code'];
            ycoor = a['pin'];

            a = Educablocks2.findPinMode(val);
            code += a['code'];
            val = a['pin'];
        ...
        Blockly.Blocks.lcd_print = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_LCD);
                this.appendValueInput('VAL').appendField(Educablocks2.locales.getKey('LANG_LCD_PRINT'));
                // .appendField(new Blockly.FieldImage('img/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_LCD_PRINT_POSITION')).appendField(new Blockly.FieldCheckbox('TRUE'), 'POS').setAlign(Blockly.ALIGN_RIGHT);
                this.last_pos = this.getFieldValue('POS');
                this.getPosition();
                this.setInputsInline(false);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_LCD_PRINT_TOOLTIP'));
            },
        ...
        Blockly.Blocks.lcd_setBacklight = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_LCD);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_LCD_SETBACKLIGHT'))
                    .appendField(new Blockly.FieldDropdown([
                        ['LOW', 'LOW'],
                        ['HIGH', 'HIGH']
                    ]), 'STATE')
                    .appendField(Educablocks2.locales.getKey('LANG_LCD_SETBACKLIGHT_CLOSE'));
                // .appendField(new Blockly.FieldImage('img/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_LCD_SETBACKLIGHT_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.logic_boolean = {
            ...
            category: Educablocks2.locales.getKey('LANG_CATEGORY_LOGIC'),
            helpUrl: Educablocks2.URL_LOGIC,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_LOGIC);
                this.setOutput(true, Boolean);
                this.appendDummyInput()
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_LOGIC_BOOLEAN_TRUE'), 'TRUE'],
                        [Educablocks2.locales.getKey('LANG_LOGIC_BOOLEAN_FALSE'), 'FALSE']
                    ]), 'BOOL');
                this.setTooltip(Educablocks2.locales.getKey('LANG_LOGIC_BOOLEAN_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.logic_compare = function() {
            ...
            var a = Educablocks2.findPinMode(argument0);
            code += a['code'];
            argument0 = a['pin'];

            a = Educablocks2.findPinMode(argument1);
            code += a['code'];
            argument1 = a['pin'];
        ...
        Blockly.Blocks.logic_compare.TOOLTIPS = {
            EQ: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_EQ'),
            NEQ: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_NEQ'),
            LT: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_LT'),
            LTE: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_LTE'),
            GT: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_GT'),
            GTE: Educablocks2.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_GTE')
        };
        ...
        Blockly.Blocks.logic_negate = {
            ...
            init: function() {
                ...
                this.appendValueInput('BOOL')
                    .setCheck(Boolean)
                    .appendField(Educablocks2.locales.getKey('LANG_LOGIC_NEGATE_INPUT_NOT'));
                this.setTooltip(Educablocks2.locales.getKey('LANG_LOGIC_NEGATE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.logic_operation = {
            ...
            init: function() {
                ...
                this.appendValueInput('B').setCheck(Boolean).appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_LOGIC_OPERATION_AND') || 'AND', 'AND'],
                    [Educablocks2.locales.getKey('LANG_LOGIC_OPERATION_OR') || 'OR', 'OR']
                ]), 'OP');
                this.setInputsInline(true);
                // Assign 'this' to a variable for use in the tooltip closure below.
                var thisBlock = this;
        ...
        Blockly.Blocks.logic_operation.TOOLTIPS = {
            AND: Educablocks2.locales.getKey('LANG_LOGIC_OPERATION_TOOLTIP_AND'),
            OR: Educablocks2.locales.getKey('LANG_LOGIC_OPERATION_TOOLTIP_OR')
        };
        ...
        Blockly.Blocks.math_arithmetic.TOOLTIPS = {
            ADD: Educablocks2.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_ADD'),
            MINUS: Educablocks2.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_MINUS'),
            MULTIPLY: Educablocks2.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_MULTIPLY'),
            DIVIDE: Educablocks2.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_DIVIDE'),
            POWER: Educablocks2.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_POWER')
        };
        ...
        Blockly.Blocks.math_array = {
            // Numeric value.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_MATH'), // Variables are handled specially.
            helpUrl: Educablocks2.URL_MATH,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_MATH);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ARRAY_ARRAY3'))
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ARRAY_BRACKET3'))
                    .appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.math_array.validator), 'NUM0')
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ARRAY_COMMA'));
                ...
                this.appendDummyInput()
                    ...
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_ARRAY_BRACKET4'));

                this.setOutput(true, Number);
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_MATH_ARRAY_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.math_modulo = {
            ...
            init: function() {
                ...
                this.appendValueInput('DIVIDEND')
                    .setCheck(Number)
                    .appendField(Educablocks2.locales.getKey('LANG_MATH_MODULO_INPUT_DIVIDEND'));
                this.appendValueInput('DIVISOR')
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField('%');
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_MATH_MODULO_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.math_number = {
            ...
            init: function() {
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_MATH_NUMBER_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.math_random = function() {
            ...
            a = Educablocks2.findPinMode(value_dmax);
            code += a['code'];
            value_dmax = a['pin'];
        ...
        Blockly.Blocks.math_random = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_MATH);
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_MATH_RANDOM'))
                    .setCheck(Number);
                this.appendValueInput('DMAX', Number)
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_MATH_RANDOM_AND'))
                    .setCheck(Number);
                this.setInputsInline(true);
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_MATH_RANDOM_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.math_single = function() {
            ...
            if (operator === 'NEG') {
                ...
                a = Educablocks2.findPinMode(arg);
                code += a['code'];
                arg = a['pin'];
                if (arg[0] === '-') {
        ...
        Blockly.Blocks.math_single = {
            ...
            init: function() {
                ...
                this.appendValueInput('NUM')
                    .setCheck(Number)
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_MATH_SINGLE_OP_ROOT') || 'SQR ROOT', 'ROOT'],
                        [Educablocks2.locales.getKey('LANG_MATH_SINGLE_OP_ABSOLUTE') || 'ABS', 'ABS'],
                        ['-', 'NEG'],
                        ['ln', 'LN'],
                        ['log10', 'LOG10'],
                        ['e^', 'EXP'],
        ...
        Blockly.Blocks.math_single.TOOLTIPS = {
            ROOT: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_ROOT'),
            ABS: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_ABS'),
            NEG: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_NEG'),
            LN: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_LN'),
            LOG10: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_LOG10'),
            EXP: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_EXP'),
            POW10: Educablocks2.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_POW10')
        };

        // Source: src/blocks/pin_analog/pin_analog.js
        /* global Blockly, profiles, Educablocks2 */
        ...
        Blockly.Blocks.pin_analog = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_VARIABLES_PIN_ANALOG'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.analog), 'PIN');

                this.setInputsInline(true);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_PIN_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.pin_digital = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_VARIABLES_PIN_DIGITAL'))
            ...
            onchange: function() {
                ...
                if (this.getFieldValue('PIN') === '0') {
                    try {
                        this.setWarningText(Educablocks2.locales.getKey('LANG_VARIABLES_PIN_DIGITAL0'));
                    } catch (e) {}
                } else {
                    try {
                        this.setWarningText(null);
        ...
        Blockly.Arduino.procedures_callnoreturn = function() {
            ...
            try {
                for (var x = 0; x < this.getVariables(funcName).length; x++) {
                    ...
                    a = Educablocks2.findPinMode(args[x]);
                    code += a['code'];
                    args[x] = a['pin'];
                }
            } catch (e) {}
        ...
        Blockly.Blocks.procedures_callnoreturn = {
            // Variable getter.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Variables are handled specially.
            helpUrl: Educablocks2.URL_PROC_NO_RET,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput('DUMMY').appendField(new Blockly.FieldDropdown(this.getProcedures()), 'PROCEDURES');
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_PROCEDURES_CALLNORETURN_TOOLTIP'));
            ...
            getProcedures: function() {
                ...
                if (procedures[0].length > 0) {
                    ...
                    procedures_dropdown.push([Educablocks2.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE'), Educablocks2.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE')]);
                }
            ...
            onchange: function() {
                ...
                if (!this.exists()) {
                    try {
                        this.setWarningText(Educablocks2.locales.getKey('LANG_PROCEDURES_CALL_WITHOUT_DEFINITION'));
                    } catch (e) {}
                } else {
                    try {
                        this.setWarningText(null);
        ...
        Blockly.Blocks.procedures_callreturn = {
            // Variable getter.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Variables are handled specially.
            helpUrl: Educablocks2.URL_PROC,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput('DUMMY').appendField(new Blockly.FieldDropdown(this.getProcedures()), 'PROCEDURES');
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_PROCEDURES_CALLRETURN_TOOLTIP'));
                this.arguments_ = this.getVariables(this.getFieldValue('PROCEDURES'));
                this.quarkConnections_ = null;
                this.quarkArguments_ = null;
                this.last_variables = this.getVariables(this.getFieldValue('PROCEDURES'));
                ...
                if (name && name.length > 0) {
                    ...
                    for (var j in Blockly.Arduino.RESERVED_WORDS_) {
                        ...
                        if (name === reserved_words[j]) {
                            this.setWarningText(Educablocks2.locales.getKey('LANG_RESERVED_WORDS'));
                            name = '';
                            break;
                        } else {
                            this.setWarningText(null);
            ...
            getProcedures: function() {
                ...
                if (procedures[1].length > 0) {
                    ...
                    procedures_dropdown.push([Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE'), Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE')]);
                }
                return procedures_dropdown;
            },
            maxVariableNumber: function() {
        ...
        Blockly.Blocks.procedures_defnoreturn = {
            ...
            category: Educablocks2.locales.getKey('LANG_CATEGORY_PROCEDURES'),
            helpUrl: Educablocks2.URL_PROC_NO_RET,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                var name = Blockly.Procedures.findLegalName(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE'), this);
                ...
                this.appendStatementInput('STACK').appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFNORETURN_DO'));
                this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
                this.setTooltip(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFNORETURN_TOOLTIP'));
                this.arguments_ = [];
            ...
            updateParams_: function() {
                ...
                if (badArg) {
                    try {
                        this.setWarningText(Educablocks2.locales.getKey('LANG_PROCEDURES_DEF_DUPLICATE_WARNING'));
                    } catch (err) {
        ...
        Blockly.Blocks.procedures_mutatorcontainer = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_MUTATORCONTAINER_Field'));
        ...
        Blockly.Blocks.procedures_mutatorarg = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_MUTATORARG_Field')).appendField(new Blockly.FieldDropdown([
                    ['int', 'int'],
                    ['String', 'String']
        ...
        Blockly.Arduino.procedures_defreturn = function() {
            ...
            if (returnValue) {
                var a = Educablocks2.findPinMode(returnValue);
                returnValue = a['code'];
        ...
        Blockly.Blocks.procedures_defreturn = {
            // Define a procedure with a return value.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Procedures are handled specially.
            helpUrl: Educablocks2.URL_PROC,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                var name = Blockly.Procedures.findLegalName(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE'), this);
                this.appendDummyInput().appendField(new Blockly.FieldTextInput(name, Blockly.Procedures.rename), 'NAME').appendField('', 'PARAMS');
                this.appendStatementInput('STACK').appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_DO'));
                this.appendValueInput('RETURN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_RETURN'));
                this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
                this.setTooltip(Educablocks2.locales.getKey('LANG_PROCEDURES_DEFRETURN_TOOLTIP'));
                this.arguments_ = [];
            },
            ...
            getReturnType: function() {
                ...
                if (returnValue.search('"') >= 0) {
                    ...
                    returnType = Educablocks2.variables[returnValue][0];
        ...
        Blockly.Arduino.procedures_ifreturn = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(condition);
            code += a['code'];
            condition = a['pin'];
            ...
            a = Educablocks2.findPinMode(value);
            code += a['code'];
            code += '  return (' + value + ');\n';
            // } else {
            //     code += '  return;\n';
        ...
        Blockly.Blocks.procedures_return = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_PROCEDURES_RETURN'));
                this.appendValueInput('VALUE');
                this.setInputsInline(true);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_PROCEDURES_RETURN_TOOLTIP'));
            ...
            onchange: function() {
                ...
                if (legal) {
                    ...
                    try {
                        this.setWarningText(Educablocks2.locales.getKey('LANG_PROCEDURES_IFRETURN_WARNING'));
                    } catch (err) {
                        console.log('Captured error: ', err);
                    }
                }
        ...
        Blockly.Arduino.serial_print = function() {
            ...
            var code = '';
            var a = Educablocks2.findPinMode(content);
            code += a['code'];
            content = a['pin'];
        ...
        Blockly.Blocks.serial_print = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendValueInput('CONTENT', String).appendField(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_PRINT'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_PRINT_TOOLTIP'));
            }
        };
        // Source: src/blocks/serial_println/serial_println.js
        /* global Blockly, profiles, JST, Educablocks2 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.serial_println = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendValueInput('CONTENT', String).appendField(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_PRINTLN'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_PRINTLN_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_read = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_READ'));
                this.setOutput(true, String);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_readstring = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_READSTRING'));
                this.setOutput(true, String);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_READSTRING_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_special = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_TAB') || 'TAB', '\\t'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_CARRIAGE_RETURN') || 'CARRIAGE RETURN', '\\r'],
                        [Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_LINE_FEED') || 'LINE FEED', '\\n']
                    ]), 'CHAR');
                this.setOutput(true, String);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.servo_cont = function() {
            ...
            code += a['code'];
            dropdown_pin = a['pin'];
            var b = Educablocks2.findPinMode(delay_time);
            code += b['code'];
            delay_time = b['pin'];
        ...
        Blockly.Blocks.servo_cont = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['servo'],
            helpUrl: Educablocks2.URL_CONTINUOUS_ROTATION_SERVO,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SERVO);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_SERVO_CONT')).appendField(new Blockly.FieldImage('img/blocks/bqservo03.png', 208 * options.zoom, 126 * options.zoom)).appendField(Educablocks2.locales.getKey('LANG_SERVO_CONT_PIN')).setCheck(Number);
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_SERVO_CONT_ROT')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_SERVO_CONT_TURN_CLOCKWISE') || 'CLOCKWISE', '0'],
                    [Educablocks2.locales.getKey('LANG_SERVO_CONT_TURN_COUNTERCLOCKWISE') || 'ANTICLOCKWISE', '180'],
                    [Educablocks2.locales.getKey('LANG_SERVO_CONT_STOPPED') || 'STOPPED', '90']
                ]), 'ROT');
                this.appendValueInput('DELAY_TIME', Number).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_SERVO_CONT_DELAY'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_SERVO_CONT_TOOLTIP'));
            },
            isVariable: function(varValue) {
                for (var i in Blockly.Variables.allVariables()) {
                    if (Blockly.Variables.allVariables()[i] === varValue) {
            ...
            onchange: function() {
                ...
                //         this.setWarningText(Educablocks2.locales.getKey('LANG_SERVO_WARNING'));
                //     } else {
                //         this.setWarningText(null);
                //     }
                // } catch (e) {}
        ...
        Blockly.Arduino.servo_move = function() {
            ...
            code += b['code'];
            delay_time = b['pin'];
            var c = Educablocks2.findPinMode(value_degree);
            code += c['code'];
            value_degree = c['pin'];
        ...
        Blockly.Blocks.servo_move = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['servo'],
            helpUrl: Educablocks2.URL_SERVO,
            /**
             * servo_move initialization
             */
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SERVO);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_SERVO_MOVE')).appendField(new Blockly.FieldImage('img/blocks/bqservo01.png', 208 * options.zoom, 126 * options.zoom)).appendField(Educablocks2.locales.getKey('LANG_SERVO_MOVE_PIN')).setCheck(Number);
                this.appendValueInput('DEGREE', Number).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_SERVO_MOVE_DEGREES'));
                this.appendValueInput('DELAY_TIME', Number).setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_SERVO_MOVE_DELAY'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_SERVO_MOVE_TOOLTIP'));
            },
            isVariable: function(varValue) {
                for (var i in Blockly.Variables.allVariables()) {
                    if (Blockly.Variables.allVariables()[i] === varValue) {
        ...
        Blockly.Blocks.text = {
            // Text value.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_TEXT'),
            helpUrl: Educablocks2.URL_TEXT,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField('"')
                    .appendField(new Blockly.FieldTextInput(''), 'TEXT')
                    .appendField('"');
                this.setOutput(true, String);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_TEXT_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.text_append = function() {
            ...
            var a = Educablocks2.findPinMode(varName);
            code += a['code'];
            varName = a['pin'];
            a = Educablocks2.findPinMode(argument0);
            code += a['code'];
            argument0 = a['pin'];
        ...
        Blockly.Blocks.text_append = {
            ...
            init: function() {
                ...
                this.appendValueInput('VAR')
                    ...
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_APPEND_TO'));
                this.appendValueInput('TEXT').appendField(Educablocks2.locales.getKey('LANG_TEXT_APPEND_APPENDTEXT'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setInputsInline(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_APPEND_TOOLTIP'));
            },
            getVars: function() {
            ...
            onchange: function() {
                ...
                //                 .appendField(Educablocks2.locales.getKey('LANG_TEXT_APPEND_TO'))
                //                 .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                //                 .appendField(Educablocks2.locales.getKey('LANG_TEXT_APPEND_APPENDTEXT'));
                //             this.setInputsInline(true);
                //         }catch(e){}
                //         this.last_variables=Blockly.Variables.allVariables();
                //     }
        ...
        Blockly.Arduino.text_equalsIgnoreCase = function() {
            ...
            var a = Educablocks2.findPinMode(string1);
            code += a['code'];
            string1 = a['pin'];

            a = Educablocks2.findPinMode(string2);
            code += a['code'];
            string2 = a['pin'];
        ...
        Blockly.Blocks.text_equalsIgnoreCase = {
            ...
            init: function() {
                ...
                this.appendValueInput('STRING1')
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_IS'));

                this.appendValueInput('STRING2')
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_EQUAL'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_QUESTION'));

                this.setInputsInline(true);

                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.text_join = {
            ...
            init: function() {
                ...
                this.appendValueInput('ADD0')
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_JOIN_Field_CREATEWITH'));
                this.appendValueInput('ADD1');
                this.setOutput(true, String);
                this.setMutator(new Blockly.Mutator(['text_create_join_item']));
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_JOIN_TOOLTIP'));
                this.itemCount_ = 2;
            },
            mutationToDom: function() {
                var container = document.createElement('mutation');
            ...
            domToMutation: function(xmlElement) {
                ...
                for (x = 0; x < this.itemCount_; x++) {
                    ...
                    if (x === 0) {
                        input.appendField(Educablocks2.locales.getKey('LANG_TEXT_JOIN_Field_CREATEWITH'));
                    }
                }
                if (this.itemCount_ === 0) {
        ...
        Blockly.Blocks.text_create_join_container = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_Field_JOIN'));
                this.appendStatementInput('STACK');
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.text_create_join_item = {
            ...
            init: function() {
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_Field_ITEM'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.text_create_join_container = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_TITLE_JOIN'));
                this.appendStatementInput('STACK');
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_TOOLTIP'));
                this.contextMenu = false;
            }
        ...
        Blockly.Blocks.text_create_join_item = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TITLE_ITEM'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TOOLTIP'));
                this.contextMenu = false;
        ...
        Blockly.Blocks.text_length = {
            ...
            init: function() {
                ...
                this.appendValueInput('VALUE')
                    ...
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_LENGTH_INPUT_LENGTH'));
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_LENGTH_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.text_substring = function() {
            ...
            a = Educablocks2.findPinMode(from);
            code += a['code'];
            from = a['pin'];

            a = Educablocks2.findPinMode(to);
            code += a['code'];
            to = a['pin'];
        ...
        Blockly.Blocks.text_substring = {
            ...
            init: function() {
                ...
                this.appendValueInput('STRING1')
                    // .setCheck(String)
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_SUBSTRING'));

                this.appendValueInput('FROM')
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_SUBSTRING_FROM'))
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT);

                this.appendValueInput('TO')
                    .appendField(Educablocks2.locales.getKey('LANG_TEXT_SUBSTRING_TO'))
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT);
                // this.appendDummyInput()
                //     .appendField(Educablocks2.locales.getKey('LANG_TEXT_SUBSTRING_QUESTION'));

                this.setInputsInline(true);

                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_TEXT_SUBSTRING_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.variables_get = function() {
            ...
            if (Educablocks2.variables[this.getFieldValue('VAR')] !== undefined) {
                this.var_type = Educablocks2.variables[this.getFieldValue('VAR')][0];
            }
            return [varName, Blockly.Arduino.ORDER_ATOMIC];
        };
        Blockly.Blocks.variables_get = {
            // Variable setter.
            category: Educablocks2.locales.getKey('LANG_CATEGORY_VARIABLES'), // Variables are handled specially.
            helpUrl: Educablocks2.URL_VAR,
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendDummyInput('DUMMY').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GET'))
                    // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                    .appendField(new Blockly.FieldVariable(' '), 'VAR');
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_GET_TOOLTIP'));
            },
            getVariables: function() {
                var variables = Blockly.Variables.allVariables();
                var dropdown = [];
            ...
            onchange: function() {
                ...
                //             .appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GET'))
                //             .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                //         this.setFieldValue(this.last_variable, 'VAR');
                //         this.last_variables=Blockly.Variables.allVariables();
                //     }
        ...
        Blockly.Arduino.variables_global = function() {
            ...
            var a = Educablocks2.findPinMode(varValue);
            ...
            if (varValue.search('"') >= 0 || varValue.search('substring\\(') >= 0) {
                ...
                varType = Educablocks2.variables[varValue][0];
                Blockly.Arduino.definitions_['declare_var' + varName] = varType + ' ' + varName + ';\n';
                Blockly.Arduino.setups_['define_var' + varName] = varName + '=' + varValue + ';\n';
            ...
            Educablocks2.variables[varName] = [varType, 'global'];
            Educablocks2.variables['analogRead(' + varName + ')'] = [varType, 'global'];
            Educablocks2.variables['digitalRead(' + varName + ')'] = [varType, 'global'];
        ...
        Blockly.Blocks.variables_global = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL')).appendField(new Blockly.FieldTextInput(''), 'VAR').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL_TOOLTIP'));
            },
            getVars: function() {
                return [this.getFieldValue('VAR')];
            },
        ...
        Blockly.Blocks.variables_global_type = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').
                appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL')).
                appendField(new Blockly.FieldTextInput(''), 'VAR').
                appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL_TYPE')).
                appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_STRING'), 'String'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_INTEGER'), 'int'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_INTEGER_LONG'), 'long'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_BYTE'), 'byte'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_FLOAT'), 'float']
                ]), "VAR_TYPE").
                appendField(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_GLOBAL_TOOLTIP'));
        ...
        Blockly.Arduino.variables_local = function() {
            ...
            Educablocks2.variables[varName] = [varType, 'local'];
            Educablocks2.variables['analogRead(' + varName + ')'] = [varType, 'local'];
            Educablocks2.variables['digitalRead(' + varName + ')'] = [varType, 'local'];
        ...
        Blockly.Blocks.variables_local = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_LOCAL')).appendField(new Blockly.FieldTextInput(''), 'VAR').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_LOCAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_LOCAL_TOOLTIP'));
            },
            getVars: function() {
                return [this.getFieldValue('VAR')];
            },
        ...
        Blockly.Blocks.variables_local_type = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').
                appendField(Educablocks2.locales.getKey('LANG_VARIABLES_LOCAL')).
                appendField(new Blockly.FieldTextInput(''), 'VAR').
                appendField(Educablocks2.locales.getKey('LANG_VARIABLES_LOCAL_TYPE')).
                appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_STRING'), 'String'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_INTEGER'), 'int'],
                    [Educablocks2.locales.getKey('LANG_VARIABLES_TYPE_INTEGER_LONG'), 'long'],
        ...
        Blockly.Blocks.variables_set = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_SET'))
                    // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                    .appendField(new Blockly.FieldVariable(' '), 'VAR').appendField(Educablocks2.locales.getKey('LANG_VARIABLES_SET_AS')).setAlign(Blockly.ALIGN_RIGHT);
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_VARIABLES_SET_TOOLTIP'));
            },
            getVariables: function() {
                var variables = Blockly.Variables.allVariables();
                var dropdown = [];
            ...
            onchange: function() {
                ...
                //             this.appendValueInput('VALUE')
                //                 .appendField(Educablocks2.locales.getKey('LANG_VARIABLES_SET'))
                //                 .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                //                 .appendField(Educablocks2.locales.getKey('LANG_VARIABLES_SET_AS'))
                //                 .setAlign(Blockly.ALIGN_RIGHT);
                //             this.setInputsInline(false);
                //             this.setFieldValue(this.last_variable, 'VAR');
                //         }catch(e){}
        ...
        Blockly.Blocks.zum_button = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ZUM_BUTTON')).appendField(new Blockly.FieldImage('img/blocks/zum02.png', 212 * options.zoom, 139 * options.zoom)).appendField(Educablocks2.locales.getKey('LANG_ZUM_BUTTON_PIN'));
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_BUTTON_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.zum_follower = function() {
            ...
            code += a['code'];
            dropdown_pin = a['pin'];
            var b = Educablocks2.findPinMode(NextPIN);
            code += b['code'];
            NextPIN = b['pin'];
            if (Educablocks2.isVariable(dropdown_pin)) {
            ...
            if (Educablocks2.isVariable(NextPIN)) {
        ...
        Blockly.Blocks.zum_follower = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendDummyInput('').appendField(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER')).appendField(new Blockly.FieldImage('img/blocks/zum06.png', 203 * options.zoom, 165 * options.zoom));
                this.appendValueInput('PIN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER_PIN_LEFT'));
                this.appendValueInput('PIN2').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER_PIN_RIGHT'));
                this.appendStatementInput('SENS1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER_LEFT'));
                this.appendStatementInput('SENS2').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER_RIGHT'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_FOLLOWER_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.zum_infrared = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN').appendField(Educablocks2.locales.getKey('LANG_ZUM_INFRARED')).appendField(new Blockly.FieldImage('img/blocks/zum07.png', 208 * options.zoom, 126 * options.zoom)).appendField(Educablocks2.locales.getKey('LANG_ZUM_INFRARED_PIN'));
                this.setOutput(true);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_INFRARED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.ADELANTE = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_ARAÑA'),
            tags: ['led'],
            helpUrl: Educablocks2.URL_LED,
            /**
            ...
            init: function() {
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADELANTE_TOOLTIP'));
            }
        };
...
Blockly.Arduino.ATRAS = function() {
        ...
        Blockly.Blocks.ATRAS = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SERVO);
                this.appendDummyInput('PIN').appendField(new Blockly.FieldImage('img/blocks/inicial7.png', 203 * options.zoom, 165 * options.zoom));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADELANTE_TOOLTIP'));
            }
...
//cocobot inicio
   ...
   Blockly.Arduino.ADELANTE2 = function() {
        ...
        Blockly.Blocks.ADELANTE2 = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_COCO'),
            tags: ['led'],
            helpUrl: Educablocks2.URL_LED,
            /**
             * ADELANTE initialization
...
Blockly.Arduino.ATRAS2 = function() {
 ...
 Blockly.Arduino.REPOSO = function() {
            Blockly.Arduino.definitions_['include_servo'] = JST['servo_cont_definitions_include']({});            
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC) || '';
            var dropdown_stat = this.getFieldValue('STAT');
            var code = '';
            ...
            dropdown_pin = a['pin'];
            if (Educablocks2.isVariable(dropdown_pin)) {
                code += JST['REPOSO_setups']({
                    'dropdown_pin': dropdown_pin,
                    'dropdown_stat': dropdown_stat
                });
            } else {
                Blockly.Arduino.setups_['setup_green_led_' + dropdown_pin] = JST['REPOSO_setups']({
                    'dropdown_pin': dropdown_pin,
                    'dropdown_stat': dropdown_stat
                });
            }
        ...
        Blockly.Blocks.REPOSO = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SERVO);
                this.appendDummyInput('PIN').appendField(new Blockly.FieldImage('img/blocks/inicial3.png', 208 * options.zoom, 140 * options.zoom));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADELANTE_TOOLTIP'));
            }
...
Blockly.Arduino.MUSICA = function() {
        ...
        Blockly.Blocks.MUSICA = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_SALIDAS'),
            tags: ['led'],
            helpUrl: Educablocks2.URL_LED,
   
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SALIDAS);
                this.appendDummyInput('PIN').appendField(new Blockly.FieldImage('img/blocks/inicial6.png', 203 * options.zoom, 165 * options.zoom));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADELANTE_TOOLTIP'));
            }
...
Blockly.Arduino.LUZ = function() {
 ...
 Blockly.Blocks.LUZ = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_SALIDAS);
                this.appendDummyInput('PIN').appendField(new Blockly.FieldImage('img/blocks/inicial5.png', 203 * options.zoom, 165 * options.zoom));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ADELANTE_TOOLTIP'));
            }
...
Blockly.Arduino.ESPERAR = function() {
            ...
            if (Educablocks2.isVariable(dropdown_pin)) {
                ...
                Blockly.Arduino.setups_['ESPERAR' + dropdown_pin] = JST['ESPERAR_setups']({
                    'dropdown_pin': dropdown_pin,
                    'dropdown_stat': dropdown_stat
                });
            }
        ...
        Blockly.Blocks.ESPERAR = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_CONTROL);
                this.appendDummyInput('PIN').appendField(new Blockly.FieldImage('img/blocks/inicial4.png', 203 * options.zoom, 165 * options.zoom));
                this.appendDummyInput().appendField(Educablocks2.locales.getKey('LANG_ZUM_LED_STATE')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks2.locales.getKey('LANG_ESPERAR_1') || '1s', '1000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_2') || '2s', '2000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_3') || '3s', '3000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_4') || '4s', '4000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_5') || '5s', '5000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_6') || '6s', '6000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_7') || '7s', '7000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_8') || '8s', '8000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_9') || '9s', '9000'],
                    [Educablocks2.locales.getKey('LANG_ESPERAR_10') || '10s', '10000']
                ]), 'STAT');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
        ...
        Blockly.Blocks.zum_photoresistor = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PHOTORESISTOR'))
                    .appendField(new Blockly.FieldImage('img/blocks/zum05.png', 208 * options.zoom, 126 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PHOTORESISTOR_PIN'));
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_PHOTORESISTOR_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.zum_piezo_buzzer = function() {
            ...
            a = Educablocks2.findPinMode(delay_time);
            code += a['code'];
            delay_time = a['pin'];
        ...
        Blockly.Blocks.zum_piezo_buzzer = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_ZUM'),
            tags: ['buzzer'],
            helpUrl: Educablocks2.URL_BUZZER,
            /**
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER'))
                    .appendField(new Blockly.FieldImage('img/blocks/zum01.png', 208 * options.zoom, 140 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_PIN'));
                this.appendDummyInput()
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_TONE'))
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_DO') || 'DO', '261'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_RE') || 'RE', '293'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_MI') || 'MI', '329'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_FA') || 'FA', '349'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_SOL') || 'SOL', '392'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_LA') || 'LA', '440'],
                        [Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_SI') || 'SI', '494']
                    ]), 'STAT'); //523
                this.appendValueInput('DURA', Number)
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_DURATION'));

                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZER_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.zum_piezo_buzzerav = function() {
            ...
            a = Educablocks2.findPinMode(Buzztone);
            code += a['code'];
            Buzztone = a['pin'];
        ...
        Blockly.Blocks.zum_piezo_buzzerav = {
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZERAV'))
                    .appendField(new Blockly.FieldImage('img/blocks/zum01.png', 208 * options.zoom, 140 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZERAV_PIN'));
                this.appendValueInput('TONE', Number)
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZERAV_TONE'));

                this.appendValueInput('DURA', Number)
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZERAV_DURATION'));

                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_PIEZO_BUZZERAV_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.zum_potentiometer = {
            category: Educablocks2.locales.getKey('LANG_CATEGORY_ZUM'),
            tags: ['potentiometer'],
            helpUrl: Educablocks2.URL_POTENTIOMETER,
            /**
            ...
            init: function() {
                this.setColour(Educablocks2.LANG_COLOUR_ZUM);
                this.appendValueInput('PIN')
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_POTENTIOMETER'))
                    .appendField(new Blockly.FieldImage('img/blocks/zum03.png', 208 * options.zoom, 139 * options.zoom))
                    .appendField(Educablocks2.locales.getKey('LANG_ZUM_POTENTIOMETER_PIN'));
                this.setOutput(true, Number);
                this.setTooltip(Educablocks2.locales.getKey('LANG_ZUM_POTENTIOMETER_TOOLTIP'));
            }
        };
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        window.Educablocks2 = Educablocks2;
    }
}));
