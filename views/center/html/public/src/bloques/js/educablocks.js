    ...
    var load = function(options) {
        ...
        (function() {
            var language = {
                ...
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'Echo',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'Trigger',
 ...
 Blockly.Arduino.ENTRADAS_potentiometer = function() {
        ...
        Blockly.Blocks.ENTRADAS_potentiometer = {
            ...
            init: function() {
                ...
                this.appendDummyInput('PIN').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_POTENTIOMETER')).appendField(new Blockly.FieldImage('img/blocks/17.png', 148 * options.zoom, 100 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_ENTRADAS_POTENTIOMETER_PIN')).appendField(new Blockly.FieldDropdown([
        ...
        Blockly.Blocks.ENTRADAS_button = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput().appendField(Educablocks.locales.getKey('LANG_ENTRADAS_BUTTON')).appendField(new Blockly.FieldImage('img/blocks/16.png', 110 * options.zoom, 110 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_ENTRADAS_BUTTON_PIN')).appendField(new Blockly.FieldDropdown([
...
Blockly.Arduino.SALIDAS_dht11 = function() {
        ...
        Blockly.Blocks.SALIDAS_dht11 = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_DHT11')).appendField(new Blockly.FieldImage('img/blocks/06.png', 148 * options.zoom, 100 * options.zoom));
...
Blockly.Arduino.SALIDAS_temperatura = function() {
        ...
        Blockly.Blocks.SALIDAS_temperatura = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_TEMPERATURA')).appendField(new Blockly.FieldImage('img/blocks/06.png', 148 * options.zoom, 100 * options.zoom));
                this.setOutput(true, Boolean);
...
Blockly.Arduino.SALIDAS_humedad = function() {
        ...
        Blockly.Blocks.SALIDAS_humedad = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_HUMEDAD')).appendField(new Blockly.FieldImage('img/blocks/06.png', 148 * options.zoom, 100 * options.zoom));
                this.setOutput(true, Boolean);
...
//fin temperatura
        ...
        Blockly.Blocks.ENTRADAS_PIR = {
            category: Educablocks.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            tags: ['pir'],
            helpUrl: Educablocks.URL_pIR,
            /**
             * ENTRADAS_PIR initialization
             */
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_PIR')).appendField(new Blockly.FieldImage('img/blocks/04.png', 148 * options.zoom, 100 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_ENTRADAS_PIR_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
        ...
        Blockly.Blocks.entradas_humedad = {
            category: Educablocks.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            tags: ['humedad suelo'],
            helpUrl: Educablocks.URL_humedad,

            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks.locales.getKey('LANG_ENTRADAS_LLUVIA')).appendField(new Blockly.FieldImage('img/blocks/05.png', 148 * options.zoom, 100 * options.zoom)).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks.locales.getKey('LANG_ENTRADAS_LLUVIA_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
...
//motor2 direccion fin
        ...
        Blockly.Blocks.entradas_sonido = {
            ...
            init: function() {
                ...
                this.appendDummyInput('PIN')
                    ...
                    .appendField(new Blockly.FieldImage('img/blocks/01.png', 148 * options.zoom, 100 * options.zoom))
        ...
        Blockly.Blocks.SALIDAS_ledrgb = {
            ...
            init: function() {
                ...
                this.appendDummyInput('PINROJO').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks.locales.getKey('LANG_SALIDAS_LEDRGB_PINROJO')).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN9') || '9', '9'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN6') || '6', '6'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN5') || '5', '5'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3']
                ]), 'NPIN1');
                this.appendDummyInput('PINVERDE').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks.locales.getKey('LANG_SALIDAS_LEDRGB_PINVERDE')).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN9') || '6', '6'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN6') || '9', '9'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN5') || '5', '5'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3']
        ...
        Blockly.Blocks.inout_analog_read = {
            ...
            init: function() {
                ...
                this.appendDummyInput('')
                    .appendField(Educablocks.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_READ'))
        ...
        Blockly.Blocks.inout_analog_write = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.pwm), 'PIN');
                 this.appendDummyInput()
                    .appendField(Educablocks.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE_VALUE')).appendField(new Blockly.FieldTextInput('255'), 'NUM')
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
        ...
        Blockly.Blocks.inout_digital_read = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_READ'))
        ...
        Blockly.Blocks.inout_digital_write = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
...
Blockly.Arduino.lcd_print = function(){
    ...
    this.setColour(Educablocks.LANG_COLOUR_LCD);
    this.appendDummyInput("")
        .appendField(Educablocks.locales.getKey('LANG_LCD_PRINT'))
        .appendField(Educablocks.locales.getKey('LANG_LCD_ADVANCED_COLUMNS'))
        ...
        .appendField(Educablocks.locales.getKey('LANG_LCD_ADVANCED_ROWS'))
...
//matriz inicio
        ...
        Blockly.Blocks.matriz_def = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_LCD);
                this.appendDummyInput().appendField(Educablocks.locales.getKey('LANG_matriz_DEF')).appendField(new Blockly.FieldImage('img/blocks/33.png', 130 * options.zoom, 150 * options.zoom));
                this.appendDummyInput()
...
//matriz print final
        ...
        Blockly.Blocks.servo_cont = {
            ...
            init: function() {
                ...
                this.appendDummyInput('PIN').appendField(Educablocks.locales.getKey('LANG_SERVO_CONT')).appendField(new Blockly.FieldImage('img/blocks/13.png', 116 * options.zoom, 110 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_SERVO_CONT_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
        ...
        Blockly.Arduino.servo_move = function() {
            ...
            code += b['code'];
            delay_time = b['pin'];
            var c = Educablocks.findPinMode(angle_angulo);
            code += c['code'];
            angle_angulo = c['pin'];
...
//servo read
       ...
       Blockly.Arduino.servo_read = function() {
        ...
        Blockly.Blocks.servo_move = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_SERVO);
                this.appendDummyInput('PIN').appendField(Educablocks.locales.getKey('LANG_SERVO_MOVE')).appendField(new Blockly.FieldImage('img/blocks/14.png', 116 * options.zoom, 110 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_SERVO_MOVE_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
        ...
        this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks.locales.getKey('LANG_SERVO_MOVE_DEGREES')).appendField(new Blockly.FieldAngle("0"), "angulo");
        this.setInputsInline(true);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
       ...
       Blockly.Arduino.variable_servo = function() {
        ...
        Blockly.Blocks.variable_servo = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_SERVO);
                this.appendDummyInput('')
                    .appendField(Educablocks.locales.getKey('LANG_SERVO'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
                this.appendDummyInput()
                .appendField("variable")
                .appendField(new Blockly.FieldVariable(" "), "variable");
...
//servo read final
        ...
        Blockly.Blocks.SALIDAS_motor = {
            ...
            init: function() {
                ...
                this.setColour(Educablocks.LANG_COLOUR_SERVO);
                this.appendDummyInput('').appendField(Educablocks.locales.getKey('LANG_SALIDAS_MOTOR')).appendField(new Blockly.FieldImage('img/blocks/02.png', 116 * options.zoom, 110 * options.zoom));
        ...
        Blockly.Blocks.salidas_led = {
            ...
            init: function() {
                this.setColour(Educablocks.LANG_COLOUR_SALIDAS);
                this.appendDummyInput().appendField(Educablocks.locales.getKey('LANG_SALIDAS_LED')).appendField(new Blockly.FieldImage('img/blocks/18.png', 148 * options.zoom, 100 * options.zoom)).appendField(Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
        ...
        Blockly.Blocks.ENTRADAS_piezo_buzzer = {
            ...
            init: function() {
                ...
                this.appendDummyInput('PIN')
                    ...
                    .appendField(new Blockly.FieldImage('img/blocks/15.png', 148 * options.zoom, 100 * options.zoom))
                ...
                this.appendDummyInput()
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_DURATION')).appendField(new Blockly.FieldTextInput('1000'), 'DURA')
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
