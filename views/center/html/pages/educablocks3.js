/*! Educablocks3 - v0.2.3 - 2016-02-02
 * https://github.com/SALIDAS/Educablocks3
...
(function(factory) {
    ...
    var load = function(options) {
        // Source: src/lang.js
        /* global Educablocks3, options */
        Educablocks3.locales = {
            defaultLanguage: {},
            languages: []
        };
        Educablocks3.locales.getLang = function() {
            return this.defaultLanguage.lngCode;
        };
        Educablocks3.locales.getKey = function(key) {
            return this.defaultLanguage[key];
        };
        Educablocks3.locales.setDefaultLang = function(langCode) {
        ...
        Educablocks3.locales.add = function(langCode, values) {
            if (!langCode) {
        ...
        Educablocks3.locales.initialize = function() {
            var lang = options.lang || window.Educablocks3Language || 'es-ES';
        ...
        (function() {
            var language = {
                ...
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Returns the u_distancia measured by the ultrasonic sensor.',
            ...
            // Browser
            // if (typeof window !== 'undefined' && this.Educablocks3 && this.Educablocks3.locales.add) {
            //     this.Educablocks3.locales.add('en', language);
            if (typeof window !== 'undefined' && Educablocks3 && Educablocks3.locales.add) {
                Educablocks3.locales.add('en-GB', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_MOTOR: 'Motor DC',
                LANG_SALIDAS_MOTOR_PIN: 'Pin',
                LANG_SALIDAS_MOTOR_DIRECCION: 'Dirección',
                LANG_SALIDAS_MOTOR_STATE: '',
                LANG_SALIDAS_MOTOR_ON: 'Encender',
                LANG_SALIDAS_MOTOR_OFF: 'Apagar',
                LANG_SALIDAS_MOTOR_TOOLTIP: 'Controla el motor DC',
                LANG_SALIDAS_MOTOR_DOBLE: 'Motores DC',
                LANG_SALIDAS_MOTOR_DOBLE_PIND: 'MD',
                LANG_SALIDAS_MOTOR_DOBLE_PINI: 'MI',
                LANG_SALIDAS_MOTOR2_DIRECCION: 'Dirección',
                LANG_SALIDAS_MOTOR_STATE: '',
                LANG_SALIDAS_MOTOR_ON: 'ON',
                LANG_SALIDAS_MOTOR_OFF: 'OFF',
                LANG_SALIDAS_MOTOR_TOOLTIP: 'Control the DC motor ',
                LANG_SALIDAS_LEDRGB: 'Led RGB',
                LANG_SALIDAS_LEDRGB_PINROJO: 'Rojo',
                LANG_SALIDAS_LEDRGB_PINVERDE: 'Verde',
                LANG_SALIDAS_LEDRGB_PINAZUL: 'Azul',
                LANG_SALIDAS_LEDRGB_COLOR: 'Color',
                ...
                LANG_SALIDAS_PIEZO_BUZZERNO: 'Apagar Zumbador',
                LANG_SALIDAS_PIEZO_BUZZERNO_PIN: 'Pin',
                ...
                LANG_LCD_ADVANCED_ROWS: 'Fila',
                LANG_LCD_ADVANCED_COLUMNS: 'Columna',
                ...
                LANG_matriz_caras_estado: 'Matriz: Cara', //Matriz
                ...
                LANG_TEXT_CODE: 'Línea de código:',
                LANG_TEXT_CODE_TOOLTIP: 'Escribir línea de código',
                LANG_TEXT_TEXT_HELPURL: '',
                ...
                LANG_ADVANCED_INOUT_ANALOG_READ: 'Leer el pin analógico',
                ...
                LANG_ADVANCED_BUILTIN_LED_ON: 'Prendido',
                ...
                LANG_ADVANCED_INOUT_DIGITAL_READ: 'Leer el pin digital',
                ...
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_HIGH: 'Prendido',
                LANG_ADVANCED_INOUT_DIGITAL_WRITE_LOW: 'Apagado',
                ...
                LANG_ADVANCED_HIGHLOW_HIGH: 'Prendido',
                LANG_ADVANCED_HIGHLOW_LOW: 'Apagado',
                LANG_ADVANCED_HIGHLOW_TOOLTIP: 'Escribe "Prendido" o "Apagado" en función de lo seleccionado.',
                ...
                LANG_SUBCATEGORY_DIGITALES: 'DIGITALES',
                LANG_SUBCATEGORY_ANALOGICAS: 'ANALÓGICAS',
                LANG_ENTRADAS_ULTRASONIDO: 'Ultrasonidos',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'Pin especial',
                ...
                LANG_ENTRADAS_OBSTACULO: 'Obstáculo',
                LANG_ENTRADAS_OBSTACULO_PIN: 'Pin',
                LANG_ENTRADAS_OBSTACULO_TOOLTIP: 'Obstáculo',
                ...
                LANG_ENTRADAS_SUELO: 'Suelo',
                LANG_ENTRADAS_SUELO_PIN: 'Pin',
                LANG_ENTRADAS_SUELO_TOOLTIP: 'Devuelve el valor analógico del sensor',
                LANG_ENTRADAS_LLUVIA: 'Lluvia',
                LANG_ENTRADAS_LLUVIA_PIN: 'Pin',
                LANG_ENTRADAS_LLUVIA_TOOLTIP: 'Devuelve el valor analógico del sensor',
                LANG_ENTRADAS_TOUCH: 'Táctil',
                LANG_ENTRADAS_TOUCH_PIN: 'Pin',
                LANG_ENTRADAS_TOUCH_TOOLTIP: 'Devuelve el valor digital medido por el sensor táctil',
                LANG_ENTRADAS_VIBRATION: 'Vibración',
                LANG_ENTRADAS_VIBRATION_PIN: 'Pin',
                LANG_ENTRADAS_VIBRATION_TOOLTIP: 'Devuelve el valor digital medido por el sensor de vibración',
                LANG_ENTRADAS_TILT: 'Inclinación',
                LANG_ENTRADAS_TILT_PIN: 'Pin',
                LANG_ENTRADAS_TILT_TOOLTIP: 'Devuelve el valor digital medido por el sensor inclinación',
                LANG_ENTRADAS_CHOQUE: 'Choque',
                LANG_ENTRADAS_CHOQUE_PIN: 'Pin',
                LANG_ENTRADAS_CHOQUE_TOOLTIP: 'Devuelve el valor digital medido por el sensor choque',
                LANG_ENTRADAS_HALL: 'Magnético',
                LANG_ENTRADAS_HALL_PIN: 'Pin',
                LANG_ENTRADAS_HALL_TOOLTIP: 'Devuelve el valor digital medido por el sensor magnético',
                LANG_ENTRADAS_SONIDO: 'Sonido',
                LANG_ENTRADAS_SONIDO_PIN: 'Pin',
                ...
                //servo blocks :
                LANG_CATEGORY_SERVO: 'MOTORES',
                LANG_SERVO_CONT: 'Servo 360',
                LANG_SERVO_CONT_PIN: 'Pin',
                LANG_SERVO_CONT_ROT: 'Rotación',
                LANG_SERVO_CONT_TURN_CLOCKWISE: 'Horario',
                LANG_SERVO_CONT_TURN_COUNTERCLOCKWISE: 'Antihorario',
                LANG_SERVO_CONT_STOPPED: 'Detener',
                LANG_SERVO_CONT_DELAY: 'Pausa [ms]',
                LANG_SERVO_CONT_TOOLTIP: 'Servo de rotación continua.',
                LANG_SERVO_MOVE: 'Servo 180',
                LANG_SERVO: 'Servo',
                LANG_SERVO_MOVE_PIN: 'Pin',
            ...
            // Browser
            // if (typeof window !== 'undefined' && this.Educablocks3 && this.Educablocks3.locales.add) {
            //     this.Educablocks3.locales.add('es', language);
            if (typeof window !== 'undefined' && Educablocks3 && Educablocks3.locales.add) {
                Educablocks3.locales.add('es-ES', language);
            }
        }());
        ...
        /* global Educablocks3, Blockly*/
        Educablocks3.locales.initialize();
        Educablocks3.variables = {};
        Educablocks3.isVariable = function(varValue) {
            for (var i in Blockly.Variables.allVariables()) {
                if (Blockly.Variables.allVariables()[i] === varValue) {
                    return true;
                }
            }
            if (Educablocks3.variables[varValue] !== undefined) {
                return true;
            }
        ...
        Educablocks3.findPinMode = function(dropdown_pin) {
            var code = '';
        ...
        /* help URLs
        Educablocks3.GITHUB_SRC_URL = 'https://github.com/SALIDAS/Educablocks3/tree/master/src/';
        Educablocks3.URL_LED = 'http://diwo.SALIDAS.com/programando-un-led-en-bitbloq-i/';
        Educablocks3.URL_LDR = 'http://diwo.SALIDAS.com/el-sensor-de-luz/';
        Educablocks3.URL_BUTTON = 'http://diwo.SALIDAS.com/programando-el-pulsador-en-bitbloq/';
        Educablocks3.URL_BUZZER = 'http://diwo.bq.com/programando-el-ENTRADASbador-en-bitbloq/';
        Educablocks3.URL_POTENTIOMETER = 'http://diwo.bq.com/programando-un-potenciometro-en-bitbloq/';
        Educablocks3.URL_IR = 'http://diwo.bq.com/programando-un-sensor-infrarrojo-en-bitbloq/';
        Educablocks3.URL_CONTINUOUS_ROTATION_SERVO = 'http://diwo.bq.com/programando-un-servo-en-bitbloq/';
        Educablocks3.URL_SERVO = 'http://diwo.bq.com/programando-un-miniservo-en-bitbloq/';
        Educablocks3.URL_LCD = 'http://diwo.bq.com/programando-una-pantalla-lcd-en-bitbloq/';
        Educablocks3.URL_US = 'http://diwo.bq.com/programando-el-sensor-ultrasonido-en-bitbloq/';
        Educablocks3.URL_BUTTONS = 'http://diwo.bq.com/programando-la-botonera-en-bitbloq/';
        Educablocks3.URL_JOYSTICK = 'http://diwo.bq.com/programando-un-joystick-con-bitbloq/';
        Educablocks3.URL_SERIE = 'http://diwo.bq.com/comunicacion-puerto-serie-en-windows-7/';
        Educablocks3.URL_IF = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-si-ejecutar/';
        Educablocks3.URL_SWITCH = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-si-switch-case/';
        Educablocks3.URL_WHILE = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-mientras/';
        Educablocks3.URL_FOR = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-contar/';
        Educablocks3.URL_FLOW_STATEMENTS = 'http://diwo.bq.com/programando-los-bloques-de-control-interrumpir/';
        Educablocks3.URL_LOGIC = 'http://diwo.bq.com/programando-los-bloques-logicos/';
        Educablocks3.URL_MATH = 'http://diwo.bq.com/programando-los-bloques-matematicos/';
        Educablocks3.URL_TEXT = 'http://diwo.bq.com/programando-los-bloques-de-texto/';
        Educablocks3.URL_BT = 'http://diwo.bq.com/ejemplo-en-bitbloq-de-comunicacion-bluetooth/';
        Educablocks3.URL_VAR = 'http://diwo.bq.com/programando-con-variables-en-bitbloq/';
        Educablocks3.URL_PROC_NO_RET = 'http://diwo.bq.com/programando-con-funciones-en-bitbloq/';
        Educablocks3.URL_PROC = 'http://diwo.bq.com/programando-con-funciones-en-bitbloq-2/';
        Educablocks3.URL_PIN_FUNC = 'http://diwo.bq.com/programando-los-bloques-funciones-pin';*/

        // RGB block colors
        Educablocks3.LANG_COLOUR_SALIDAS = '#F44336';
        Educablocks3.LANG_COLOUR_ENTRADAS = '#9C27B0';
        Educablocks3.LANG_COLOUR_ENTRADAS_DIGITALES = '#9C27B0';
        Educablocks3.LANG_COLOUR_ENTRADAS_ANALOGICAS = '#9C27B0';
        Educablocks3.LANG_COLOUR_SERVO = '#2196F3';
        Educablocks3.LANG_COLOUR_LCD = '#3F51B5';
        Educablocks3.LANG_COLOUR_CONTROL = '#e91e63';
        Educablocks3.LANG_COLOUR_LOGIC = '#009688';
        Educablocks3.LANG_COLOUR_MATH = '#00BCD4';
        Educablocks3.LANG_COLOUR_TEXT = '#4CAF50';
        Educablocks3.LANG_COLOUR_COMMUNICATION = '#00BFA5';
        Educablocks3.LANG_COLOUR_ADVANCED = '#FF9800';
        Educablocks3.LANG_COLOUR_VARIABLES = '#FF5722';
        Educablocks3.LANG_COLOUR_PROCEDURES = '#651FFF';
        ...
        this["JST"]["SALIDAS_gyro_definitions_u_distancia"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
                __p += 'long u_distancia(int trigger_pin, int echo_pin)\n{\n  long microseconds = u_tiempo(trigger_pin, echo_pin);\n  long u_distancia;\n  u_distancia = microseconds/29/2;\n  if (u_distancia == 0){\n    u_distancia = 999;\n  }\n  return u_distancia;\n}\n';

            }
            return __p
        };

        this["JST"]["SALIDAS_gyro_definitions_u_tiempo"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["SALIDAS_ace_definitions_u_distancia"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["SALIDAS_ace_definitions_u_tiempo"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["SALIDAS_bat_definitions_u_distancia"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["SALIDAS_bat_definitions_u_tiempo"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["entradas_suelo"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["entradas_lluvia"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_TOUCH"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_TOUCH_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_TILT"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_TILT_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_CHOQUE"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_CHOQUE_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_HALL"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_HALL_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
            ...
            return __p
                ...
                this["JST"]["ENTRADAS_VIBRATION"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_VIBRATION_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
...
//motor doble
        ...
        this["JST"]["SALIDAS_motor_doble"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
                __p += __p += 'digitalWrite(' +
                    ...
                    ',' +
                    ((__t = (direccion1)) == null ? '' : __t) +
                    ');\n digitalWrite(' +
                    ((__t = (dropdown_pin2)) == null ? '' : __t) +
                    ','+
                    ((__t = (direccion2)) == null ? '' : __t) +
                    ');\n digitalWrite(' +
                    ((__t = (dropdown_pin3)) == null ? '' : __t) +
                    ','+
                    ((__t = (direccion3)) == null ? '' : __t) +
                    ');\n digitalWrite(' +
                    ((__t = (dropdown_pin4)) == null ? '' : __t) +
                    ','+
                    ((__t = (direccion4)) == null ? '' : __t) +');\n';

            }
            return __p
        };

     this["JST"]["SALIDAS_motor_doble_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
...
//servo read fin
 ...
 this["JST"]["ENTRADAS_obstaculo"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["ENTRADAS_obstaculo_setups"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
 ...
 this["JST"]["entradas_follower"] = function(obj) {
        ...
        this["JST"]["ENTRADAS_piezo_buzzerno"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        /* global Blockly, JST, Educablocks3 */
        /* jshint sub:true */
        ...
        Blockly.Arduino.advanced_conversion = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(value_num);
            code += a['code'];
            value_num = a['pin'];
        ...
        Blockly.Blocks.advanced_conversion = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_COMMUNICATION'),
            helpUrl: Educablocks3.URL_SERIE,
            /**
             * advanced_conversion initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_CONVERT'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_DECIMAL') || 'DEC', 'DEC'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_HEXADECIMAL') || 'HEX', 'HEX'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_OCTAL') || 'OCT', 'OCT'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_BINARY') || 'BIN', 'BIN']
                    ]), 'CONV');
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_VALUE'))
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .setCheck(Number);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_CONVERSION_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.advanced_map = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(num);
            code += a['code'];
            num = a['pin'];

            a = Educablocks3.findPinMode(from_min);
            code += a['code'];
            from_min = a['pin'];

            a = Educablocks3.findPinMode(from_max);
            code += a['code'];
            from_max = a['pin'];

            a = Educablocks3.findPinMode(to_min);
            code += a['code'];
            to_min = a['pin'];

            a = Educablocks3.findPinMode(to_max);
            code += a['code'];
            to_max = a['pin'];
        ...
        Blockly.Blocks.advanced_map = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_MATH'),
            helpUrl: Educablocks3.URL_MATH,
            /**
             * advanced_map initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_MATH);
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_MAP'))
                    .setCheck(Number);
                this.appendValueInput('FROM_MIN', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_FROM'))
                    .setCheck(Number);
                this.appendValueInput('FROM_MAX', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_HYPHEN'))
                    .setCheck(Number);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_BRACKET'));
                this.appendValueInput('TO_MIN', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_TO'))
                    .setCheck(Number);
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_MATH_ADVANCED_MAP_TOOLTIP'));
            }
        };

        // Source: src/blocks/array_get/array_get.js
        /* global Blockly, Educablocks3 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.array_get = {
            // Numeric value.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_VARIABLES'),
            helpUrl: Educablocks3.URL_VAR,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendDummyInput('DUMMY').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GET')).appendField(new Blockly.FieldVariable(' '), 'VAR');
                // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                this.appendDummyInput('DUMMY2').appendField(Educablocks3.locales.getKey('LANG_ARRAY_GET_BRACKET1')).appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.array_get.validator), 'INDEX').appendField(Educablocks3.locales.getKey('LANG_ARRAY_GET_BRACKET2'));
                this.setOutput(true, Number);
                this.setInputsInline(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ARRAY_GET_TOOLTIP'));
            },
            ...
            onchange: function() {
                ...
                for (var i in variables) {
                    if (Blockly.Variables.allVariables()[i] !== this.last_variables[i]) {
                        ...
                        this.appendDummyInput('DUMMY').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GET')).appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                        this.appendDummyInput('DUMMY2').appendField(Educablocks3.locales.getKey('LANG_ARRAY_GET_BRACKET1')).appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.array_get.validator), 'INDEX').appendField(Educablocks3.locales.getKey('LANG_ARRAY_GET_BRACKET2'));
                ...
                try {
                    if (!this.exists()) {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_VARIABLES_CALL_WITHOUT_DEFINITION'));
                    } else {
        ...
        Blockly.Blocks.base_delay = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_LED,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_BASE_DELAY_WAIT')).appendField(new Blockly.FieldTextInput('1000'), 'delay')
                this.setInputsInline(false);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_BASE_DELAY_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.base_map = function() {
            ...
            a = Educablocks3.findPinMode(value_dmax);
            code += a['code'];
            value_dmax = a['pin'];
        ...
        Blockly.Blocks.base_map = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_MATH);
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_BASE_MAP'))
                    .setCheck(Number);
                this.appendValueInput('DMAX', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_BASE_MAP_VALUE_TO'))
                    .setCheck(Number);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_BASE_MAP_BRACKET'));
                this.setInputsInline(true);
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_MATH_BASE_MAP_TOOLTIP'));
            }
        };

        // Source: src/blocks/ENTRADAS_button/ENTRADAS_button.js
        /* global Blockly, options, JST, Educablocks3 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Arduino.ENTRADAS_button = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            code += a['code'];
            dropdown_pin = a['pin'];
            if (Educablocks3.isVariable(dropdown_npin)) {
        ...
        Blockly.Blocks.ENTRADAS_button = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_DIGITALES"),
            category_colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['button'],
            helpUrl: Educablocks3.URL_BUTTON,
            /**
             * ENTRADAS_button initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_BUTTON')).appendField(new Blockly.FieldImage('img/blocks/educablocks/16.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_BUTTON_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN6') || '6', '6'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN7') || '7', '7'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN8') || '8', '8'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN9') || '9', '9'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN10') || '10', '10'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN13') || '13', '13']
                ]), 'NPIN');
                this.setInputsInline(false);
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_BUTTON_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.base_millis = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_BASE_MILLIS'));
                this.setOutput(true, 'Number');
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_BASE_MILLIS_TOOLTIP'));
            }
        };
   Blockly.Arduino.ENTRADAS_GYRO = function() {
            ...
            var code = '';
            a = Educablocks3.findPinMode(trigger_pin);
            code += a['code'];
            trigger_pin = a['pin'];

            Blockly.Arduino.definitions_['define_SALIDAS_gyro_u_tiempo'] = JST['SALIDAS_gyro_definitions_u_tiempo']({});
            if (Educablocks3.isVariable(dropdown_stat)) {
         ...
         Blockly.Arduino.ENTRADAS_ACE = function() {
            ...
            Blockly.Arduino.definitions_['define_SALIDAS_ace_u_tiempo'] = JST['SALIDAS_ace_definitions_u_tiempo']({});
            if (Educablocks3.isVariable(dropdown_stat)) {
                code += JST['SALIDAS_bat_setups_echo']({
                    'dropdown_stat': dropdown_stat
                });
        ...
        //alert(this.getFieldValue('NPIN'));

          switch (this.getFieldValue('NPIN')) {
                case '3':
                    echo_pin = '2';
                    trigger_pin= '3';
                     break;
            ...
            var code = '';
            var a = Educablocks3.findPinMode(echo_pin);
            code += a['code'];
            echo_pin = a['pin'];
            ...
            Blockly.Arduino.definitions_['define_SALIDAS_bat_u_tiempo'] = JST['SALIDAS_bat_definitions_u_tiempo']({});
            Blockly.Arduino.definitions_['define_SALIDAS_bat_u_distancia'] = JST['SALIDAS_bat_definitions_u_distancia']({});
            if (Educablocks3.isVariable(echo_pin)) {
                code += JST['SALIDAS_bat_setups_echo']({
                    'echo_pin': echo_pin
                });
            } else {
            ...
            if (Educablocks3.isVariable(trigger_pin)) {
        ...
        Blockly.Blocks.entradas_ultrasonido = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['ultrasonido'],
            helpUrl: Educablocks3.URL_US,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_ULTRASONIDO')).appendField(new Blockly.FieldImage('img/blocks/educablocks/09.png', 164 * options.zoom, 85 * options.zoom));
                this.appendDummyInput('PIN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_ULTRASONIDO_RED_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'E3', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'E4', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'E6', '6']
                ]), 'NPIN');
                this.setInputsInline(false);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_ULTRASONIDO_TOOLTIP'));
            }
        };
     ...
     /*        Blockly.Blocks.ENTRADAS_ACE = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_ACE')).appendField(new Blockly.FieldImage('img/blocks/educablocks/45.png', 208 * options.zoom, 140 * options.zoom));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
        ...
        Blockly.Blocks.ENTRADAS_GYRO = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_GYRO')).appendField(new Blockly.FieldImage('img/blocks/educablocks/45.png', 208 * options.zoom, 140 * options.zoom));
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_GYRO_EJE'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_GYRO_EJE_X') || 'GX', 'gx'],
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_GYRO_EJE_Y') || 'GY', 'gy'],
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_GYRO_EJE_Z') || 'GZ', 'gz'],
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_ACE_EJE_X') || 'AX', 'ax'],
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_ACE_EJE_Y') || 'AY', 'ay'],
                        [Educablocks3.locales.getKey('LANG_ENTRADAS_ACE_EJE_Z') || 'AZ', 'az'],
                    ]), 'STAT') //523
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.setInputsInline(false);
        ...
        Blockly.Arduino.SALIDAS_bluetooth_def = function() {
            ...
            if (this.getFieldValue('TOGGLE') === 'FALSE') {
                ...
                dropdown_pin = a['pin'];
                a = Educablocks3.findPinMode(NextPIN);
            ...
            var b = Educablocks3.findPinMode(baud_rate);
        ...
        Blockly.Blocks.SALIDAS_bluetooth_def = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_COMMUNICATION'),
            tags: ['bluetooth'],
            helpUrl: Educablocks3.URL_BT,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_DEF')).appendField(new Blockly.FieldImage('img/blocks/educablocks/03.png', 60 * options.zoom, 110 * options.zoom));
                this.appendValueInput('BAUD_RATE').setCheck(Number).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE')).setAlign(Blockly.ALIGN_RIGHT);
                this.setInputsInline(false);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP'));
            },
        ...
        Blockly.Blocks.SALIDAS_bluetooth_receive = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_RECEIVE'));
                // .appendField(new Blockly.FieldImage('img/blocks/educablocks/SALIDASmod03.png', 208 * options.zoom, 100 * options.zoom));

                this.setInputsInline(false);


                this.setOutput(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.SALIDAS_bluetooth_send = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(statement_send);
            code += a['code'];
        ...
        Blockly.Blocks.SALIDAS_bluetooth_send = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_SEND'));
                // .appendField(new Blockly.FieldImage('img/blocks/educablocks/SALIDASmod03.png', 208 * options.zoom, 100 * options.zoom));

                this.appendValueInput('SNT')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_SEND_SEND'));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP'));
            }
        };
...
Blockly.Arduino.SALIDAS_dht11 = function() {
        ...
        Blockly.Blocks.SALIDAS_dht11 = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_DHT11')).appendField(new Blockly.FieldImage('img/blocks/educablocks/06.png', 60 * options.zoom, 110 * options.zoom));
                this.appendDummyInput('NUM PIN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_DHT11_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN9') || '9', '9'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN8') || '8', '8'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN7') || '7', '7'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN6') || '6', '6'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN5') || '5', '5'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || '2', '2']
                ]), 'NPIN');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_DHT11_TOOLTIP'));
            }
        };
...
Blockly.Arduino.SALIDAS_temperatura = function() {
        ...
        Blockly.Blocks.SALIDAS_temperatura = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TEMPERATURA')).appendField(new Blockly.FieldImage('img/blocks/educablocks/06.png', 60 * options.zoom, 110 * options.zoom));
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_TEMPERATURA_TOOLTIP'));
            }
        };
...
Blockly.Arduino.SALIDAS_humedad = function() {
        ...
        Blockly.Blocks.SALIDAS_humedad = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_HUMEDAD')).appendField(new Blockly.FieldImage('img/blocks/educablocks/06.png', 60 * options.zoom, 110 * options.zoom));
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_HUMEDAD_TOOLTIP'));
            }
        };
...
//fin temperatura
        ...
        Blockly.Arduino.ENTRADAS_TOUCH = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_TOUCH_setups']({
                    'dropdown_npin': dropdown_npin
                });
            } else {
                Blockly.Arduino.setups_['setup_infrared_' + dropdown_npin] = JST['ENTRADAS_TOUCH_setups']({
                    'dropdown_npin': dropdown_npin
                });
            }
            code += JST['ENTRADAS_TOUCH']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        };

        Blockly.Blocks.ENTRADAS_TOUCH = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_DIGITALES"),
            category_colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['Touch'],
            helpUrl: Educablocks3.URL_touch,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH')).appendField(new Blockly.FieldImage('img/blocks/educablocks/04.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_TOOLTIP'));
            }
        };

      Blockly.Arduino.ENTRADAS_obstaculo = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            dropdown_pin = a['pin'];
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_obstaculo_setups']({
                    'dropdown_npin': dropdown_npin
                                    });
            } else {
                Blockly.Arduino.setups_['setup_button_' + dropdown_npin] = JST['ENTRADAS_obstaculo_setups']({
                    'dropdown_npin': dropdown_npin

                });
            }
            code += JST['ENTRADAS_obstaculo']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        ...
        Blockly.Blocks.ENTRADAS_obstaculo = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_OBSTACULO')).appendField(new Blockly.FieldImage('img/blocks/educablocks/51.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_BUTTON_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
                ...
                this.setInputsInline(false);
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_OBSTACULO_TOOLTIP'));
            }
        };


        Blockly.Arduino.ENTRADAS_VIBRATION = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_VIBRATION_setups']({
                    'dropdown_npin': dropdown_npin
                });
            } else {
                Blockly.Arduino.setups_['setup_infrared_' + dropdown_npin] = JST['ENTRADAS_VIBRATION_setups']({
                    'dropdown_npin': dropdown_npin
                });
            }
            code += JST['ENTRADAS_VIBRATION']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        };
        ...
        Blockly.Blocks.ENTRADAS_VIBRATION = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['Vibración'],
            helpUrl: Educablocks3.URL_VIBRATION,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_VIBRATION')).appendField(new Blockly.FieldImage('img/blocks/educablocks/40.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_VIBRATION_TOOLTIP'));
            }
        };



        Blockly.Arduino.ENTRADAS_TILT = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_TILT_setups']({
                    'dropdown_npin': dropdown_npin
                });
            } else {
                Blockly.Arduino.setups_['setup_infrared_' + dropdown_npin] = JST['ENTRADAS_TILT_setups']({
                    'dropdown_npin': dropdown_npin
                });
            }
            code += JST['ENTRADAS_TILT']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        };
       ...
       Blockly.Arduino.ENTRADAS_infrared = function() {
           ...
           Blockly.Blocks.ENTRADAS_infrared = {
            ...
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_DIGITALES"),
            tags: ['optico'],
            helpUrl: Educablocks3.URL_infrared,
            /**
             * ENTRADAS_infrared initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_INFRARED')).appendField(new Blockly.FieldImage('img/blocks/educablocks/52.png', 60 * options.zoom, 110* options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_INFRARED_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_INFRARED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.ENTRADAS_TILT = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['Tilt'],
            helpUrl: Educablocks3.URL_TILT,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TILT')).appendField(new Blockly.FieldImage('img/blocks/educablocks/41.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_TILT_TOOLTIP'));
            }
        };


      Blockly.Arduino.ENTRADAS_CHOQUE = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_CHOQUE_setups']({
                    'dropdown_npin': dropdown_npin
                });
            } else {
                Blockly.Arduino.setups_['setup_infrared_' + dropdown_npin] = JST['ENTRADAS_CHOQUE_setups']({
                    'dropdown_npin': dropdown_npin
                });
            }
            code += JST['ENTRADAS_CHOQUE']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        };
        ...
        Blockly.Blocks.ENTRADAS_CHOQUE = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['Choque'],
            helpUrl: Educablocks3.URL_CHOQUE,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_CHOQUE')).appendField(new Blockly.FieldImage('img/blocks/educablocks/42.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_CHOQUE_TOOLTIP'));
            }
        };
...
Blockly.Arduino.ENTRADAS_follower = function() {
            ...
            var NextPIN = this.getFieldValue('NPIN2');
            ...
            code += a['code'];
            dropdown_pin = a['pin'];
            var b = Educablocks3.findPinMode(NextPIN);
            code += b['code'];
            NextPIN = b['pin'];
            if (Educablocks3.isVariable(dropdown_pin)) {
            ...
            if (Educablocks3.isVariable(NextPIN)) {
        ...
        Blockly.Blocks.ENTRADAS_follower = {
            ...
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_DIGITALES"),
            tags: ['follower'],
            helpUrl: Educablocks3.URL_IR,

               init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_FOLLOWER')).appendField(new Blockly.FieldImage('img/blocks/educablocks/522.png', 60 * options.zoom, 110 * options.zoom));
                this.appendDummyInput('PIN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_FOLLOWER_PIN_LEFT')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.appendDummyInput('PIN2').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_FOLLOWER_PIN_RIGHT')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.appendStatementInput('SENS1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_entradas_FOLLOWER_LEFT'));
                this.appendStatementInput('SENS2').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_entradas_FOLLOWER_RIGHT'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_entradas_FOLLOWER_TOOLTIP'));
            }
        };


    Blockly.Arduino.ENTRADAS_HALL = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            ...
            if (Educablocks3.isVariable(dropdown_npin)) {
                code += JST['ENTRADAS_HALL_setups']({
                    'dropdown_npin': dropdown_npin
                });
            } else {
                Blockly.Arduino.setups_['setup_infrared_' + dropdown_npin] = JST['ENTRADAS_HALL_setups']({
                    'dropdown_npin': dropdown_npin
                });
            }
            code += JST['ENTRADAS_HALL']({
                'dropdown_npin': dropdown_npin
            });
            return [code, Blockly.Arduino.ORDER_ATOMIC];
        };
        ...
        Blockly.Blocks.ENTRADAS_HALL = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['Hall'],
            helpUrl: Educablocks3.URL_HALL,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_HALL')).appendField(new Blockly.FieldImage('img/blocks/educablocks/53.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_TOUCH_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_HALL_TOOLTIP'));
            }
        };
...
Blockly.Arduino.ENTRADAS_potentiometer = function() {
        ...
        Blockly.Blocks.ENTRADAS_potentiometer = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_ANALOGICAS"),
            category_colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['potenciometro'],
            helpUrl: Educablocks3.URL_POTENTIOMETER,
            /**
             * ENTRADAS_potentiometer initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_POTENTIOMETER')).appendField(new Blockly.FieldImage('img/blocks/educablocks/17.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_POTENTIOMETER_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN9') || 'A4', 'A4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN8') || 'A5', 'A5']
                ]), 'NPIN');
                this.setInputsInline(false);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_POTENTIOMETER_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.ENTRADAS_photoresistor = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['sensor de luz'],
            helpUrl: Educablocks3.URL_LDR,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_PHOTORESISTOR')).appendField(new Blockly.FieldImage('img/blocks/educablocks/19.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_PHOTORESISTOR_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP'));
            }
        };

        Blockly.Arduino.entradas_suelo = function() {
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';


            code += JST['entradas_suelo']({
                'dropdown_npin': dropdown_npin
            });
        ...
        Blockly.Blocks.entradas_suelo = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_ANALOGICAS"),
            category_colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['suelo'],
            helpUrl: Educablocks3.URL_humedad,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_SUELO')).appendField(new Blockly.FieldImage('img/blocks/educablocks/05.png', 75 * options.zoom, 135 * options.zoom)).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_SUELO_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_SUELO_TOOLTIP'));
            }
        };


        Blockly.Arduino.entradas_lluvia = function() {
            var dropdown_npin = this.getFieldValue('NPIN');
            var code = '';


            code += JST['entradas_lluvia']({
                'dropdown_npin': dropdown_npin
            });
        ...
        Blockly.Blocks.entradas_lluvia = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADAS'),
            subcategory: Educablocks3.locales.getKey("LANG_SUBCATEGORY_ANALOGICAS"),
            category_colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_LLUVIA')).appendField(new Blockly.FieldImage('img/blocks/educablocks/50.png', 75 * options.zoom, 135 * options.zoom)).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_LLUVIA_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_LLUVIA_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.SALIDAS_buttons = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SALIDAS'),
            tags: ['buttons'],
            helpUrl: Educablocks3.URL_BUTTONS,
            /**
             * SALIDAS_buttons initialization
             *
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendValueInput('PIN')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS'))
                    .appendField(new Blockly.FieldImage('img/blocks/educablocks/10.png', 336 * options.zoom, 176 * options.zoom))
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_PIN'))
                    .setCheck(Number);
                this.appendStatementInput('BUTN1')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_BUTTON_A'));
                this.appendStatementInput('BUTN2')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_BUTTON_B'));
                this.appendStatementInput('BUTN3')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_BUTTON_C'));
                this.appendStatementInput('BUTN4')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_BUTTON_D'));
                this.appendStatementInput('BUTN5')
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_BUTTON_E'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_BUTTONS_TOOLTIP'));
            }
        };
...
/*AREST INICIO
   ...
   Blockly.Arduino.SALIDAS_arest_def = function() {
        ...
        Blockly.Blocks.SALIDAS_arest_def = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_AREST_DEF'));
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_AREST_rename')).appendField(new Blockly.FieldCheckbox('FALSE'), 'TOGGLE').setAlign(Blockly.ALIGN_RIGHT);
                this.checkBT();
                this.last_toogle = this.getFieldValue('TOGGLE');
                this.setInputsInline(false);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_AREST_DEF_TOOLTIP'));
            },
            checkBT: function() {
                if (this.getFieldValue('TOGGLE') === 'FALSE') {
                    try {
                    ...
                    this.appendValueInput('ID').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_AREST_DEF_ID')).setAlign(Blockly.ALIGN_RIGHT);
                    this.appendValueInput('NAME').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_AREST_DEF_NAME')).setAlign(Blockly.ALIGN_RIGHT);
                }
            },
            onchange: function() {
...
//scaner i2c
   ...
   Blockly.Arduino.SALIDAS_scan_def = function() {
        ...
        Blockly.Blocks.SALIDAS_scan_def = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_SCAN_DEF'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_SCAN_DEF_TOOLTIP'));
             }
        };
...
//panel ble
 ...
 /*       Blockly.Blocks.SALIDAS_ble_def = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_BLE_DEF'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_BLE_DEF_TOOLTIP'));
             }
        };
...
/*
        ...
        Blockly.Arduino.SALIDAS_joystick = function() {
            ...
            var a = Educablocks3.findPinMode(pinx);
            code += a['code'];
            pinx = a['pin'];

            a = Educablocks3.findPinMode(piny);
            code += a['code'];
            piny = a['pin'];

            a = Educablocks3.findPinMode(pinbutton);
            code += a['code'];
            pinbutton = a['pin'];
            ...
            if (Educablocks3.isVariable(pinbutton)) {
         ...
         */
          /**Blockly.Blocks.SALIDAS_joystick = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SALIDAS'),
            tags: ['joystick'],
            helpUrl: Educablocks3.URL_JOYSTICK,
            /**
             * SALIDAS_joystick initialization

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK')).appendField(new Blockly.FieldImage('img/blocks/educablocks/11.png', 209 * options.zoom, 277 * options.zoom));
                // this.appendValueInput('POS')
                //     .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK_POSITION'))
                //     .setAlign(Blockly.ALIGN_RIGHT)
                //     .setCheck(Number);
                this.appendValueInput('PINX').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK_PIN_X')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.appendValueInput('PINY').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK_PIN_Y')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.appendValueInput('PINBUTTON').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK_PIN_BUTTON')).setAlign(Blockly.ALIGN_RIGHT).setCheck(Number);
                this.setOutput(true, Number);
                // this.setPreviousStatement(true, null);
                // this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_JOYSTICK_TOOLTIP'));
            }
        };
...
/*
       ...
       Blockly.Arduino.entradas_sonido = function() {
        ...
        Blockly.Blocks.entradas_sonido = {
            ...
            colour: Educablocks3.LANG_COLOUR_ENTRADAS,
            tags: ['sonido'],
            helpUrl: Educablocks3.URL_sonido,

            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_SONIDO')).appendField(new Blockly.FieldImage('img/blocks/educablocks/01.png', 60 * options.zoom, 110 * options.zoom)).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_ENTRADAS_SONIDO_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'A0', 'A0'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'A1', 'A1'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || 'A2', 'A2'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || 'A3', 'A3'],
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ENTRADAS_SONIDO_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.salidas_led = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LED')).appendField(new Blockly.FieldImage('img/blocks/educablocks/18.png', 60 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LED_STATE')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_ON') || 'ON', 'HIGH'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_OFF') || 'OFF', 'LOW']
                ]), 'STAT');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_LED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.bt_serial_available = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_BT_SERIAL_AVAILABLE'));
                this.appendStatementInput('DO')
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_REPEAT_INPUT_DO'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_BT_SERIAL_AVAILABLE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.controls_doWhile = {
            // Do/while loop.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            // helpUrl: Educablocks3.URL_DOWHILE,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendStatementInput('DO').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_DOWHILE_OPERATOR_DO'));
                this.appendValueInput('WHILE').setCheck(Boolean).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_TITLE_REPEAT')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE'), 'WHILE'],
                    [Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL'), 'UNTIL']
                ]), 'MODE');
                // this.appendValueInput('WHILE').setCheck(Boolean).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_DOWHILE_OPERATOR_WHILE'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_DOWHILE_TOOLTIP'));
            }
        };

        // Source: src/blocks/controls_execute/controls_execute.js
        /* global Blockly, profiles, JST, Educablocks3 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.controls_execute = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendValueInput('CONTENT', String).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_EXECUTE'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_EXECUTE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.controls_flow_statements = {
            // Flow statements: continue, break.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_FLOW_STATEMENTS,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                var dropdown = new Blockly.FieldDropdown(
                    [
                        [Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK') || 'BREAK', 'BREAK'],
                        [Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE') || 'CONTINUE', 'CONTINUE']
                    ]);
                this.appendDummyInput()
                    .appendField(dropdown, 'FLOW')
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_INPUT_OFLOOP'));
                this.setPreviousStatement(true);
            ...
            onchange: function() {
                ...
                if (legal) {
                    ...
                    try {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_WARNING'));
                    } catch (err) {
        ...
        Blockly.Blocks.controls_flow_statements.TOOLTIPS = {
            BREAK: Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK'),
            CONTINUE: Educablocks3.locales.getKey('LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE')
        };
        ...
        Blockly.Arduino.controls_for = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(variable0);
            code += a['code'];
            variable0 = a['pin'];

            a = Educablocks3.findPinMode(argument0);
            code += a['code'];
            argument0 = a['pin'];

            a = Educablocks3.findPinMode(argument1);
            code += a['code'];
            argument1 = a['pin'];
        ...
        Blockly.Blocks.controls_for = {
            // For loop.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_FOR,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendValueInput('VAR').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_WITH'));
                // .appendField(new Blockly.FieldVariable(' '), 'VAR');
                this.appendValueInput('FROM').setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_FROM'));
                this.appendValueInput('TO').setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_TO'));
                this.appendStatementInput('DO').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_DO'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setInputsInline(true);
                // Assign 'this' to a variable for use in the tooltip closure below.
                var thisBlock = this;
                this.setTooltip(function() {
                    return Educablocks3.LANG_CONTROLS_FOR_TOOLTIP.replace('%1', thisBlock.getFieldValue('VAR'));
                });
            },
            getVars: function() {
            ...
            onchange: function() {
                try {
                    if (this.isVariable(Blockly.Arduino.valueToCode(this, 'FROM', Blockly.Arduino.ORDER_ATOMIC))) {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_FROM_WARNING'));
                    } else if (this.isVariable(Blockly.Arduino.valueToCode(this, 'TO', Blockly.Arduino.ORDER_ATOMIC))) {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_TO_WARNING'));
                    } else {
                        this.setWarningText(null);
                    }
                } catch (e) {}
                ...
                //                 .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_WITH'))
                //                 .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                //             this.appendValueInput('FROM')
                //                 .setCheck(Number)
                //                 .setAlign(Blockly.ALIGN_RIGHT)
                //                 .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_FROM'));
                //             this.appendValueInput('TO')
                //                 .setCheck(Number)
                //                 .setAlign(Blockly.ALIGN_RIGHT)
                //                 .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_TO'));
                //             this.appendStatementInput('DO')
                //                 .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_FOR_INPUT_DO'));
                //         }catch(e){}
                //         this.last_variables=Blockly.Variables.allVariables();
                //     }
                // }
        ...
        Blockly.Arduino.controls_if = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(argument);
            code += a['code'];
            argument = a['pin'];
        ...
        Blockly.Blocks.controls_if = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_IF,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendValueInput('IF0')
                    .setCheck(Boolean)
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_IF'));
                this.appendStatementInput('DO0')
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_THEN'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                ...
                this.setTooltip(function() {
                    if (!thisBlock.elseifCount_ && !thisBlock.elseCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_IF_TOOLTIP_1');
                    } else if (!thisBlock.elseifCount_ && thisBlock.elseCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_IF_TOOLTIP_2');
                    } else if (thisBlock.elseifCount_ && !thisBlock.elseCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_IF_TOOLTIP_3');
                    } else if (thisBlock.elseifCount_ && thisBlock.elseCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_IF_TOOLTIP_4');
                    }
                    return '';
                });
                this.elseifCount_ = 0;
            ...
            domToMutation: function(xmlElement) {
                ...
                for (var x = 1; x <= this.elseifCount_; x++) {
                    this.appendValueInput('IF' + x)
                        .setCheck(Boolean)
                        .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_ELSEIF'));
                ...
                if (this.elseCount_) {
                    this.appendStatementInput('ELSE')
                        .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_ELSE'))
                        .setAlign(Blockly.ALIGN_RIGHT);
                }
            },
                ...
                while (clauseBlock) {
                    switch (clauseBlock.type) {
                        case 'controls_if_elseif':
                            ...
                            doInput.appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_THEN'))
                                .setAlign(Blockly.ALIGN_RIGHT);
                        ...
                        case 'controls_if_else':
                            ...
                            elseInput.appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_ELSE'))
                                .setAlign(Blockly.ALIGN_RIGHT);
                            // Reconnect any child blocks.
                            if (clauseBlock.statementConnection_) {
        ...
        Blockly.Blocks.controls_if_if = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_IF_Field_IF'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.appendStatementInput('STACK');
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_IF_IF_TOOLTIP'));
        ...
        Blockly.Blocks.controls_if_elseif = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_ELSEIF_Field_ELSEIF'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_IF_ELSEIF_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.controls_if_else = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_ELSE_Field_ELSE'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.setPreviousStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_IF_ELSE_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.controls_setupLoop = {
            // Setup statements.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            // helpUrl: Educablocks3.URL_SETUP,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendStatementInput('SETUP').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SETUP_LOOP_SETUP_TITLE'));
                this.appendStatementInput('LOOP').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SETUP_LOOP_LOOP_TITLE'));
                this.setPreviousStatement(false);
                this.setNextStatement(false);
                this.setTooltip(Educablocks3.locales.getKey('LANG_CONTROLS_SETUP_LOOP_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.controls_switch = {
            // switch condition.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_SWITCH,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendValueInput('IF0')
                    .setCheck(Boolean)
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                ...
                this.setTooltip(function() {
                    if (!thisBlock.switchCount_ && !thisBlock.defaultCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_TOOLTIP_1');
                    } else if (!thisBlock.switchCount_ && thisBlock.defaultCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_TOOLTIP_2');
                    } else if (thisBlock.switchCount_ && !thisBlock.defaultCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_TOOLTIP_3');
                    } else if (thisBlock.switchCount_ && thisBlock.defaultCount_) {
                        return Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_TOOLTIP_4');
                    }
                    return '';
                });
            ...
            domToMutation: function(xmlElement) {
                ...
                for (var x = 1; x <= this.switchCount_; x++) {
                    this.appendValueInput('SWITCH' + x)
                        .setCheck(Number)
                        .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_CASE'))
                        .setAlign(Blockly.ALIGN_RIGHT);
                    this.setInputsInline(true);
                    this.appendStatementInput('DO' + x)
                        .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_THEN'))
                ...
                if (this.defaultCount_) {
                    this.appendStatementInput('DEFAULT')
                        .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_DEFAULT'))
                        .setAlign(Blockly.ALIGN_RIGHT);
                }
            },
            decompose: function(workspace) {
                    ...
                    switch (clauseBlock.type) {
                        case 'controls_switch_case':
                            ...
                            if (this.switchCount_ === 1) {
                                case_lang = Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_IS');
                            } else {
                                case_lang = Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_CASE');
                            }
                            ...
                            doInput.appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_DO'))
                                .setAlign(Blockly.ALIGN_RIGHT);
                            // Reconnect any child blocks.
                            if (clauseBlock.valueConnection_) {
                        ...
                        case 'controls_switch_default':
                            ...
                            defaultInput.appendField(Educablocks3.locales.getKey('LANG_CONTROLS_SWITCH_DEFAULT'))
                                .setAlign(Blockly.ALIGN_RIGHT);
                            // Reconnect any child blocks.
                            if (clauseBlock.statementConnection_) {
        ...
        Blockly.Arduino.controls_whileUntil = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(argument0);
            code += a['code'];
            argument0 = a['pin'];
        ...
        Blockly.Blocks.controls_whileUntil = {
            // Do while/until loop.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_CONTROLS'),
            helpUrl: Educablocks3.URL_WHILE,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_CONTROL);
                this.appendValueInput('BOOL').setCheck(Boolean).appendField(Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_TITLE_REPEAT')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE'), 'WHILE'],
                    [Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL'), 'UNTIL']
                ]), 'MODE');
                this.appendStatementInput('DO').appendField(Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_INPUT_DO'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                // Assign 'this' to a variable for use in the tooltip closure below.
                var thisBlock = this;
        ...
        Blockly.Blocks.controls_whileUntil.TOOLTIPS = {
            WHILE: Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE'),
            UNTIL: Educablocks3.locales.getKey('LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL')
        };
        ...
        Blockly.Blocks.inout_analog_read = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ADVANCED'),
            helpUrl: Educablocks3.URL_PIN_FUNC,
            /**
             * inout_analog_read initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_READ'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.analog), 'PIN');
                this.setInputsInline(true);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.inout_analog_write = function() {
            ...
            var b = Educablocks3.findPinMode(value_num);
            code += b['code'];
            value_num = b['pin'];
        ...
        Blockly.Blocks.inout_analog_write = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.pwm), 'PIN');
                 this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE_VALUE')).appendField(new Blockly.FieldTextInput('255'), 'NUM')
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_ANALOG_WRITE_TOOLTIP'));
            }
        };



        Blockly.Arduino.inout_analog_write2 = function() {
            var dropdown_pin = this.getFieldValue('PIN') || '';
            var value_num = this.getFieldValue('variable');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
            code += a['code'];
            dropdown_pin = a['pin'];
         ...
         * @type {Object}
         */
        Blockly.Blocks.inout_analog_write2 = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ADVANCED'),
            helpUrl: Educablocks3.URL_PIN_FUNC,
            /**
             * inout_analog_write initialization
        ...
        Blockly.Blocks.inout_builtin_led = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_BUILTIN_LED'))
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_BUILTIN_LED_STATE'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_ADVANCED_BUILTIN_LED_ON') || 'ON', 'HIGH'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_BUILTIN_LED_OFF') || 'OFF', 'LOW']
                    ]), 'STAT');
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_BUILTIN_LED_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_digital_read = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_READ'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
                this.setInputsInline(true);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.inout_digital_write = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_STATE')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_HIGH') || 'HIGH', 'HIGH'],
                    [Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_LOW') || 'LOW', 'LOW']
                ]), 'STAT');
                this.setPreviousStatement(true, null);
                this.setInputsInline(true);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_TOOLTIP'));
            }
        };



     Blockly.Arduino.inout_digital_write3 = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var dropdown_stat = this.getFieldValue('STAT');
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin);
         ...
         * @type {Object}
         */
        Blockly.Blocks.inout_digital_write3 = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ADVANCED'),
            helpUrl: Educablocks3.URL_PIN_FUNC,
            /**
             * inout_digital_write initialization
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendValueInput('PIN').appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE')).appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_PIN'));
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_STATE')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_HIGH') || 'HIGH', 'HIGH'],
                    [Educablocks3.locales.getKey('LANG_ADVANCED_INOUT_DIGITAL_WRITE_LOW') || 'LOW', 'LOW']
                ]), 'STAT');
        ...
        Blockly.Blocks.inout_highlow = {
            ...
            init: function() {
                ...
                this.appendDummyInput('')
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_ADVANCED_HIGHLOW_HIGH') || 'HIGH', 'HIGH'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_HIGHLOW_LOW') || 'LOW', 'LOW']
                    ]), 'BOOL');
                this.setOutput(true, Boolean);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_HIGHLOW_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.lcd_i2c = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_LCD'),
            tags: ['lcd_i2c'],
            helpUrl: Educablocks3.URL_LCD,
            /**
             * lcd_slave initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_LCD_I2C')).appendField(new Blockly.FieldImage('img/blocks/educablocks/30.png', 180 * options.zoom, 65 * options.zoom));
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_LCD_DIRECCION'))
                    .appendField(new Blockly.FieldTextInput('0x27'), 'LCD_DIRECCION')
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_LCD_DEF_TOOLTIP'));
            }
        };
...
Blockly.Arduino.lcd_print = function(){
    ...
    var curs_col = this.getFieldValue('CURSOR_COLUMN');
    var curs_row=this.getFieldValue('CURSOR_ROW');
    var output = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || '';
    ...
    this.setColour(Educablocks3.LANG_COLOUR_LCD);
    this.appendDummyInput("")
        .appendField(Educablocks3.locales.getKey('LANG_LCD_PRINT'))
        .appendField(Educablocks3.locales.getKey('LANG_LCD_ADVANCED_COLUMNS'))
        ...
        .appendField(Educablocks3.locales.getKey('LANG_LCD_ADVANCED_ROWS'))
    ...
    this.setPreviousStatement(true,null);
    this.setNextStatement(true,null);
    this.setTooltip(Educablocks3.locales.getKey('LANG_LCD_PRINT_TOOLTIP'));
  }
};
...
Blockly.Arduino.lcd_setBacklight = function() {
        ...
        Blockly.Blocks.lcd_setBacklight = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_LCD_SETBACKLIGHT'))
                    .appendField(new Blockly.FieldDropdown([
                        ['LOW', 'LOW'],
                        ['HIGH', 'HIGH']
                    ]), 'STATE')
                    .appendField(Educablocks3.locales.getKey('LANG_LCD_SETBACKLIGHT_CLOSE'));
                // .appendField(new Blockly.FieldImage('img/blocks/educablocks/SALIDASmod03.png', 208 * options.zoom, 100 * options.zoom));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_LCD_SETBACKLIGHT_TOOLTIP'));
            }
        };
      ...
      Blockly.Arduino.lcd_clear = function() {
        ...
        Blockly.Blocks.lcd_clear = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_LCD_CLEAR'));
                // .appendField(new Blockly.FieldImage('img/blocks/educablocks/SALIDASmod03.png', 208 * options.zoom, 100 * options.zoom));
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_LCD_CLEAR_TOOLTIP'));
            }
        };

        // Source: src/blocks/lcd_def/lcd_def.js
        /* global Blockly, JST, options, Educablocks3 */
        /* jshint sub:true */
        /**
        ...
        Blockly.Blocks.lcd_def = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_LCD_DEF')).appendField(new Blockly.FieldImage('img/blocks/educablocks/12.png', 208 * options.zoom, 100 * options.zoom));
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_LCD_PINS'))
...
//matriz inicio
        ...
        Blockly.Blocks.matriz_def = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_matriz_DEF')).appendField(new Blockly.FieldImage('img/blocks/educablocks/33.png', 130 * options.zoom, 150 * options.zoom));
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_matriz_DEF_TOOLTIP'));
            }
        };
...
//segundo caras inicio
     Blockly.Arduino.matriz_caras_def = function() {
        ...
        Blockly.Blocks.matriz_caras_def = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_LCD'),
            tags: ['matriz'],
            helpUrl: Educablocks3.URL_CONTINUOUS_ROTATION_SERVO,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_matriz_caras_estado'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_matriz_caras_feliz') || 'Feliz', 'sonrisa_bmp'],
                        [Educablocks3.locales.getKey('LANG_matriz_caras_sorprendido') || 'Sorprendido', 'sorprendido_bmp'],
                        [Educablocks3.locales.getKey('LANG_matriz_caras_enojado') || 'Enojado', 'enojado_bmp'],
                    ]), 'STAT')
            this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_matriz_caras_DEF_TOOLTIP'));
            }
        };
//segundo caras final
...
//matriz print
        ...
        Blockly.Arduino.matriz_print = function() {
            ...
            var a = Educablocks3.findPinMode(xcoor);
            code += a['code'];
            xcoor = a['pin'];

            a = Educablocks3.findPinMode(ycoor);
            code += a['code'];
            ycoor = a['pin'];

            a = Educablocks3.findPinMode(val);
            code += a['code'];
            val = a['pin'];
        ...
        Blockly.Blocks.matriz_print = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LCD);
                this.appendValueInput('VAL').appendField(Educablocks3.locales.getKey('LANG_matriz_PRINT'));
                this.setInputsInline(false);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_matriz_PRINT_TOOLTIP'));
            },
...
//matriz print final
        ...
        Blockly.Blocks.logic_boolean = {
            ...
            category: Educablocks3.locales.getKey('LANG_CATEGORY_LOGIC'),
            helpUrl: Educablocks3.URL_LOGIC,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_LOGIC);
                this.setOutput(true, Boolean);
                this.appendDummyInput()
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_LOGIC_BOOLEAN_TRUE'), 'TRUE'],
                        [Educablocks3.locales.getKey('LANG_LOGIC_BOOLEAN_FALSE'), 'FALSE']
                    ]), 'BOOL');
                this.setTooltip(Educablocks3.locales.getKey('LANG_LOGIC_BOOLEAN_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.logic_compare.TOOLTIPS = {
            EQ: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_EQ'),
            NEQ: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_NEQ'),
            LT: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_LT'),
            LTE: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_LTE'),
            GT: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_GT'),
            GTE: Educablocks3.locales.getKey('LANG_LOGIC_COMPARE_TOOLTIP_GTE')
        };
        ...
        Blockly.Blocks.logic_negate = {
            ...
            init: function() {
                ...
                this.appendValueInput('BOOL')
                    .setCheck(Boolean)
                    .appendField(Educablocks3.locales.getKey('LANG_LOGIC_NEGATE_INPUT_NOT'));
                this.setTooltip(Educablocks3.locales.getKey('LANG_LOGIC_NEGATE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.logic_operation = {
            ...
            init: function() {
                ...
                this.appendValueInput('B').setCheck(Boolean).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_LOGIC_OPERATION_AND') || 'AND', 'AND'],
                    [Educablocks3.locales.getKey('LANG_LOGIC_OPERATION_OR') || 'OR', 'OR']
                ]), 'OP');
                this.setInputsInline(true);
                // Assign 'this' to a variable for use in the tooltip closure below.
                var thisBlock = this;
        ...
        Blockly.Blocks.logic_operation.TOOLTIPS = {
            AND: Educablocks3.locales.getKey('LANG_LOGIC_OPERATION_TOOLTIP_AND'),
            OR: Educablocks3.locales.getKey('LANG_LOGIC_OPERATION_TOOLTIP_OR')
        };
        ...
        Blockly.Blocks.math_arithmetic.TOOLTIPS = {
            ADD: Educablocks3.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_ADD'),
            MINUS: Educablocks3.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_MINUS'),
            MULTIPLY: Educablocks3.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_MULTIPLY'),
            DIVIDE: Educablocks3.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_DIVIDE'),
            POWER: Educablocks3.locales.getKey('LANG_MATH_ARITHMETIC_TOOLTIP_POWER')
        };
        ...
        Blockly.Blocks.math_array = {
            // Numeric value.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_MATH'), // Variables are handled specially.
            helpUrl: Educablocks3.URL_MATH,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_MATH);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ARRAY_ARRAY3'))
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ARRAY_BRACKET3'))
                    .appendField(new Blockly.FieldTextInput('0', Blockly.Blocks.math_array.validator), 'NUM0')
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ARRAY_COMMA'));
                ...
                this.appendDummyInput()
                    ...
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_ARRAY_BRACKET4'));

                this.setOutput(true, Number);
                this.setInputsInline(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_MATH_ARRAY_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.math_modulo = {
            ...
            init: function() {
                ...
                this.appendValueInput('DIVIDEND')
                    .setCheck(Number)
                    .appendField(Educablocks3.locales.getKey('LANG_MATH_MODULO_INPUT_DIVIDEND'));
                this.appendValueInput('DIVISOR')
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField('%');
                this.setInputsInline(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_MATH_MODULO_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.math_number = {
            ...
            init: function() {
                ...
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_MATH_NUMBER_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.math_random = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_MATH);
                this.appendValueInput('NUM', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_MATH_RANDOM'))
                    .setCheck(Number);
                this.appendValueInput('DMAX', Number)
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_MATH_RANDOM_AND'))
                    .setCheck(Number);
                this.setInputsInline(true);
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_MATH_RANDOM_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.math_single = function() {
            ...
            if (operator === 'NEG') {
                ...
                a = Educablocks3.findPinMode(arg);
                code += a['code'];
                arg = a['pin'];
                if (arg[0] === '-') {
        ...
        Blockly.Blocks.math_single = {
            ...
            init: function() {
                ...
                this.appendValueInput('NUM')
                    .setCheck(Number)
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_MATH_SINGLE_OP_ROOT') || 'SQR ROOT', 'ROOT'],
                        [Educablocks3.locales.getKey('LANG_MATH_SINGLE_OP_ABSOLUTE') || 'ABS', 'ABS'],
                        ['-', 'NEG'],
                        ['ln', 'LN'],
                        ['log10', 'LOG10'],
                        ['e^', 'EXP'],
        ...
        Blockly.Blocks.math_single.TOOLTIPS = {
            ROOT: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_ROOT'),
            ABS: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_ABS'),
            NEG: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_NEG'),
            LN: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_LN'),
            LOG10: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_LOG10'),
            EXP: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_EXP'),
            POW10: Educablocks3.locales.getKey('LANG_MATH_SINGLE_TOOLTIP_POW10')
        };

        // Source: src/blocks/pin_analog/pin_analog.js
        /* global Blockly, profiles, Educablocks3 */
        ...
        Blockly.Blocks.pin_analog = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_VARIABLES_PIN_ANALOG'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.analog), 'PIN');

                this.setInputsInline(true);
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_PIN_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.pin_digital = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ADVANCED);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_VARIABLES_PIN_DIGITAL'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
            ...
            onchange: function() {
                ...
                if (this.getFieldValue('PIN') === '0') {
                    try {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_VARIABLES_PIN_DIGITAL0'));
                    } catch (e) {}
                } else {
                    try {
                        this.setWarningText(null);
        ...
        Blockly.Arduino.procedures_callnoreturn = function() {
            ...
            try {
                for (var x = 0; x < this.getVariables(funcName).length; x++) {
                    ...
                    a = Educablocks3.findPinMode(args[x]);
                    code += a['code'];
                    args[x] = a['pin'];
                }
            } catch (e) {}
        ...
        Blockly.Blocks.procedures_callnoreturn = {
            // Variable getter.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Variables are handled specially.
            helpUrl: Educablocks3.URL_PROC_NO_RET,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput('DUMMY').appendField(new Blockly.FieldDropdown(this.getProcedures()), 'PROCEDURES');
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_CALLNORETURN_TOOLTIP'));
            ...
            getProcedures: function() {
                ...
                if (procedures[0].length > 0) {
                    ...
                    procedures_dropdown.push([Educablocks3.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE'), Educablocks3.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE')]);
                }
            ...
            onchange: function() {
                ...
                if (!this.exists()) {
                    try {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_PROCEDURES_CALL_WITHOUT_DEFINITION'));
                    } catch (e) {}
                } else {
                    try {
                        this.setWarningText(null);
        ...
        Blockly.Blocks.procedures_callreturn = {
            // Variable getter.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Variables are handled specially.
            helpUrl: Educablocks3.URL_PROC,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput('DUMMY').appendField(new Blockly.FieldDropdown(this.getProcedures()), 'PROCEDURES');
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_CALLRETURN_TOOLTIP'));
                this.arguments_ = this.getVariables(this.getFieldValue('PROCEDURES'));
                this.quarkConnections_ = null;
                this.quarkArguments_ = null;
                this.last_variables = this.getVariables(this.getFieldValue('PROCEDURES'));
                ...
                if (name && name.length > 0) {
                    ...
                    for (var j in Blockly.Arduino.RESERVED_WORDS_) {
                        ...
                        if (name === reserved_words[j]) {
                            this.setWarningText(Educablocks3.locales.getKey('LANG_RESERVED_WORDS'));
                            name = '';
                            break;
                        } else {
                            this.setWarningText(null);
            ...
            getProcedures: function() {
                ...
                if (procedures[1].length > 0) {
                    ...
                    procedures_dropdown.push([Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE'), Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE')]);
                }
                return procedures_dropdown;
            },
            maxVariableNumber: function() {
        ...
        Blockly.Blocks.procedures_defnoreturn = {
            ...
            category: Educablocks3.locales.getKey('LANG_CATEGORY_PROCEDURES'),
            helpUrl: Educablocks3.URL_PROC_NO_RET,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                var name = Blockly.Procedures.findLegalName(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFNORETURN_PROCEDURE'), this);
                ...
                this.appendStatementInput('STACK').appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFNORETURN_DO'));
                this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFNORETURN_TOOLTIP'));
                this.arguments_ = [];
            ...
            updateParams_: function() {
                ...
                if (badArg) {
                    try {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_PROCEDURES_DEF_DUPLICATE_WARNING'));
                    } catch (err) {
                        console.log('Captured error: ', err);
                    }
                } else {
        ...
        Blockly.Blocks.procedures_mutatorcontainer = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_MUTATORCONTAINER_Field'));
                this.appendStatementInput('STACK');
                this.setTooltip('');
                this.contextMenu = false;
            }
        ...
        Blockly.Blocks.procedures_mutatorarg = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_MUTATORARG_Field')).appendField(new Blockly.FieldDropdown([
                    ['int', 'int'],
                    ['String', 'String']
        ...
        Blockly.Arduino.procedures_defreturn = function() {
            ...
            if (returnValue) {
                var a = Educablocks3.findPinMode(returnValue);
                returnValue = a['code'];
        ...
        Blockly.Blocks.procedures_defreturn = {
            // Define a procedure with a return value.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_PROCEDURES'), // Procedures are handled specially.
            helpUrl: Educablocks3.URL_PROC,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                var name = Blockly.Procedures.findLegalName(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_PROCEDURE'), this);
                this.appendDummyInput().appendField(new Blockly.FieldTextInput(name, Blockly.Procedures.rename), 'NAME').appendField('', 'PARAMS');
                this.appendStatementInput('STACK').appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_DO'));
                this.appendValueInput('RETURN').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_RETURN'));
                this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_TOOLTIP'));
                this.arguments_ = [];
            },
            isVariable: function(varValue) {
                for (var i in Blockly.Variables.allVariables()) {
            ...
            getReturnType: function() {
                ...
                if (returnValue.search('"') >= 0) {
                    ...
                    returnType = Educablocks3.variables[returnValue][0];
        ...
        Blockly.Arduino.procedures_ifreturn = function() {
            ...
            var condition = Blockly.Arduino.valueToCode(this, 'CONDITION',
                Blockly.Arduino.ORDER_NONE) || '';
            var code = '';
            var a = Educablocks3.findPinMode(condition);
            code += a['code'];
            condition = a['pin'];
            ...
            a = Educablocks3.findPinMode(value);
            code += a['code'];
            code += '  return (' + value + ');\n';
            // } else {
            //     code += '  return;\n';
        ...
        Blockly.Blocks.procedures_ifreturn = {
            ...
            init: function() {
                ...
                this.appendValueInput('CONDITION')
                    ...
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_IF_MSG_IF'));
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_DEFRETURN_RETURN'));
                this.appendValueInput('VALUE');
                this.setInputsInline(true);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_IFRETURN_TOOLTIP'));
            ...
            onchange: function() {
                ...
                if (legal) {
                    ...
                    try {
                        this.setWarningText(Educablocks3.locales.getKey('LANG_PROCEDURES_IFRETURN_WARNING'));
                    } catch (err) {
                        console.log('Captured error: ', err);
                    }
                }
        ...
        Blockly.Arduino.procedures_return = function() {
            ...
            var code = '';
            var value = Blockly.Arduino.valueToCode(this, 'VALUE', Blockly.Arduino.ORDER_NONE) || '';
            var a = Educablocks3.findPinMode(value);
            code += a['code'];
            code += '  return (' + value + ');\n';
            return code;
        };
        ...
        Blockly.Blocks.procedures_return = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_PROCEDURES);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_PROCEDURES_RETURN'));
                this.appendValueInput('VALUE');
                this.setInputsInline(true);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_PROCEDURES_RETURN_TOOLTIP'));
                this.hasReturnValue_ = true;
            },
            mutationToDom: function() {
                // Save whether this block has a return value.
        ...
        Blockly.Blocks.serial_available = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_AVAILABLE'));
                this.appendStatementInput('DO')
                    .appendField(Educablocks3.locales.getKey('LANG_CONTROLS_REPEAT_INPUT_DO'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_AVAILABLE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_parseint = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PARSEINT'));
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PARSEINT_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.serial_print = function() {
            var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC);
            var code = '';
            var a = Educablocks3.findPinMode(content);
            code += a['code'];
            content = a['pin'];
        ...
        Blockly.Blocks.serial_print = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendValueInput('CONTENT', String).appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PRINT'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PRINT_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_println = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendValueInput('CONTENT', String).appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PRINTLN'));
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_PRINTLN_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_read = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_READ'));
                this.setOutput(true, String);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_READ_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_readstring = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_READSTRING'));
                this.setOutput(true, String);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_READSTRING_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.serial_special = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_TAB') || 'TAB', '\\t'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_CARRIAGE_RETURN') || 'CARRIAGE RETURN', '\\r'],
                        [Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_LINE_FEED') || 'LINE FEED', '\\n']
                    ]), 'CHAR');
                this.setOutput(true, String);
                this.setTooltip(Educablocks3.locales.getKey('LANG_ADVANCED_SERIAL_SPECIAL_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.servo_cont = function() {
            ...
            code += a['code'];
            dropdown_pin = a['pin'];
            var b = Educablocks3.findPinMode(delay_time);
            code += b['code'];
            delay_time = b['pin'];
        ...
        Blockly.Blocks.servo_cont = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['servo'],
            helpUrl: Educablocks3.URL_CONTINUOUS_ROTATION_SERVO,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_SERVO_CONT')).appendField(new Blockly.FieldImage('img/blocks/educablocks/13.png', 116 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_SERVO_CONT_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
                ...
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SERVO_CONT_ROT')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SERVO_CONT_TURN_CLOCKWISE') || 'CLOCKWISE', '0'],
                    [Educablocks3.locales.getKey('LANG_SERVO_CONT_TURN_COUNTERCLOCKWISE') || 'ANTICLOCKWISE', '180'],
                    [Educablocks3.locales.getKey('LANG_SERVO_CONT_STOPPED') || 'STOPPED', '90']
                ]), 'ROT');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SERVO_CONT_TOOLTIP'));
            },
            isVariable: function(varValue) {
                for (var i in Blockly.Variables.allVariables()) {
                    if (Blockly.Variables.allVariables()[i] === varValue) {
            ...
            onchange: function() {
                ...
                //         this.setWarningText(Educablocks3.locales.getKey('LANG_SERVO_WARNING'));
                //     } else {
                //         this.setWarningText(null);
                //     }
                // } catch (e) {}
        ...
        Blockly.Arduino.servo_move = function() {
            var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
            var angle_angulo = this.getFieldValue('angulo');
            ...
            code += b['code'];
            delay_time = b['pin'];
            var c = Educablocks3.findPinMode(angle_angulo);
            code += c['code'];
            angle_angulo = c['pin'];
...
//servo read
       ...
       Blockly.Arduino.servo_read = function() {
        ...
        Blockly.Blocks.servo_move = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['servo'],
            helpUrl: Educablocks3.URL_SERVO,
            /**
             * servo_move initialization
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('PIN').appendField(Educablocks3.locales.getKey('LANG_SERVO_MOVE')).appendField(new Blockly.FieldImage('img/blocks/educablocks/14.png', 116 * options.zoom, 110 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_SERVO_MOVE_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
        ...
        this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SERVO_MOVE_DEGREES')).appendField(new Blockly.FieldAngle("0"), "angulo");
        this.setInputsInline(true);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip(Educablocks3.locales.getKey('LANG_SERVO_MOVE_TOOLTIP'));
            },
            isVariable: function(varValue) {
                for (var i in Blockly.Variables.allVariables()) {
                    if (Blockly.Variables.allVariables()[i] === varValue) {
...
//variable servo
       ...
       Blockly.Arduino.variable_servo = function() {
            var dropdown_npin = this.getFieldValue('PIN') || '';
            var value_degree = this.getFieldValue('variable');
            var dropdown_pin = this.getFieldValue('NPIN') || '';
            var delay_time = Blockly.Arduino.valueToCode(this, 'DELAY_TIME', Blockly.Arduino.ORDER_ATOMIC) || '';
            Blockly.Arduino.definitions_['include_servo'] = JST['servo_cont_definitions_include']({});
            var code = '';
        ...
        Blockly.Blocks.variable_servo = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_SERVO'))
                    .appendField(new Blockly.FieldDropdown(profiles.default.digital), 'PIN');
                this.appendDummyInput()
                .appendField("variable")
                .appendField(new Blockly.FieldVariable(" "), "variable");
...
//variable servo final
        ...
        Blockly.Blocks.servo_read = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_SERVO_READ')).appendField(Educablocks3.locales.getKey('LANG_SERVO_READ_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN2') || '2', '2'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN3') || '3', '3'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN4') || '4', '4'],
                    [Educablocks3.locales.getKey('ENTRADAS_BUTTON_PIN5') || '5', '5'],
...
//servo read final
        ...
        Blockly.Arduino.SALIDAS_motor = function() {
          ...
          switch (this.getFieldValue('NPIN1')) {
                case '3':
                    direccion1  = 'HIGH';
                     direccion2 = 'LOW';
                     break;
            ...
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin1);
            code += a['code'];
            dropdown_pin1 = a['pin'];

            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin2);
            code += a['code'];
            dropdown_pin2 = a['pin'];


            var code = '';
            var a = Educablocks3.findPinMode(direccion1);
            code += a['code'];
            direccion1 = a['pin'];


            var code = '';
            var a = Educablocks3.findPinMode(direccion2);
            code += a['code'];
            direccion2 = a['pin'];



            if (Educablocks3.isVariable(dropdown_pin2 + dropdown_pin1)) {
                ...
                Blockly.Arduino.setups_['' + dropdown_pin2 + dropdown_pin1] = JST['SALIDAS_motor_setups']({
                    'dropdown_pin1': dropdown_pin1,
                    'dropdown_pin2': dropdown_pin2,
                    'direccion2': direccion2,
                    'direccion1': direccion1
        ...
        Blockly.Blocks.SALIDAS_motor = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['motor'],
            helpUrl: Educablocks3.URL_MOTOR,

            init: function() {

                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR')).appendField(new Blockly.FieldImage('img/blocks/educablocks/02.png', 186 * options.zoom, 152 * options.zoom));
                this.appendDummyInput('PIN1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'E3', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'E4', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'E6', '6']
                ]), 'NPIN');
                this.appendDummyInput('PIN1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_DIRECCION')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'Adelante', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'Atrás', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'Frenar', '6']
                ]), 'NPIN1');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_TOOLTIP'));
            }
        };


        Blockly.Arduino.SALIDAS_motor_doble = function() {
          ...
          switch (this.getFieldValue('NPIN')) {
            ...
            switch (this.getFieldValue('NPIN2')) {
                case '3':
                    dropdown_pin3  = '2';
                    dropdown_pin4 = '3';
                     break;
          ...
          switch (this.getFieldValue('NPIN1')) {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin3);
            code += a['code'];
            dropdown_pin3 = a['pin'];

            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pin4);
            code += a['code'];
            dropdown_pin4 = a['pin'];
            ...
            var code = '';
            var a = Educablocks3.findPinMode(direccion3);
            code += a['code'];
            direccion3 = a['pin'];

            var code = '';
            var a = Educablocks3.findPinMode(direccion4);
            code += a['code'];
            direccion4 = a['pin'];



            if (Educablocks3.isVariable(dropdown_pin2 + dropdown_pin1 + dropdown_pin3 + dropdown_pin4)) {
                code += JST['SALIDAS_motor_doble_setups']({
                    'dropdown_pin1': dropdown_pin1,
                    'dropdown_pin2': dropdown_pin2,
                    'dropdown_pin3': dropdown_pin3,
                    'dropdown_pin4': dropdown_pin4,
                    'direccion2': direccion2,
                    'direccion1': direccion1,
                ...
                Blockly.Arduino.setups_['' + dropdown_pin2 + dropdown_pin1 + dropdown_pin3 + dropdown_pin4] = JST['SALIDAS_motor_doble_setups']({
                    'dropdown_pin1': dropdown_pin1,
                    'dropdown_pin2': dropdown_pin2,
                    'dropdown_pin3': dropdown_pin3,
                    'dropdown_pin4': dropdown_pin4,
        ...
        Blockly.Blocks.SALIDAS_motor_doble = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SERVO'),
            tags: ['motor doble'],
            helpUrl: Educablocks3.URL_MOTOR,
            ...
            init: function() {
                ...
                this.setColour(Educablocks3.LANG_COLOUR_SERVO);
                this.appendDummyInput('').appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_DOBLE')).appendField(new Blockly.FieldImage('img/blocks/educablocks/022.png', 186 * options.zoom, 152 * options.zoom));
                this.appendDummyInput('PIN1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_DOBLE_PIND')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'E3', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'E4', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'E6', '6']
                ]), 'NPIN');
                this.appendDummyInput('PIN1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_DOBLE_PINI')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'E3', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'E4', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'E6', '6']
                ]), 'NPIN2');
                this.appendDummyInput('PIN1').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_MOTOR_DIRECCION')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || 'Adelante', '3'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || 'Atrás', '4'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'Derecha', '5'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'Izquierda', '6'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN2') || 'Frenar', '7']
                ]), 'NPIN1');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
        ...
        Blockly.Blocks.text = {
            // Text value.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_TEXT'),
            helpUrl: Educablocks3.URL_TEXT,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField('"')
                    .appendField(new Blockly.FieldTextInput(''), 'TEXT')
                    .appendField('"');
                this.setOutput(true, String);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_TEXT_TOOLTIP'));
            }
        };

      Blockly.Arduino.textcode = function() {
            // Text value.
            var code = this.getFieldValue('TEXT');
            return code + '\n';
        };

        Blockly.Blocks.textcode = {
            // Text value.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_TEXT'),
            tags: ['code'],
            helpUrl: Educablocks3.URL_TEXT_CODE,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_TEXT);
                this.appendDummyInput('pin')
                .appendField(Educablocks3.locales.getKey('LANG_TEXT_CODE'))
                .setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldTextInput(''), 'TEXT');
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_CODE_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.text_append = function() {
            ...
            var a = Educablocks3.findPinMode(varName);
            code += a['code'];
            varName = a['pin'];
            a = Educablocks3.findPinMode(argument0);
            code += a['code'];
        ...
        Blockly.Blocks.text_append = {
            ...
            init: function() {
                ...
                this.appendValueInput('VAR')
                    // .appendField(new Blockly.FieldVariable(' '), 'VAR')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_APPEND_TO'));
                this.appendValueInput('TEXT').appendField(Educablocks3.locales.getKey('LANG_TEXT_APPEND_APPENDTEXT'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setInputsInline(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_APPEND_TOOLTIP'));
            },
            getVars: function() {
                return [this.getFieldValue('VAR')];
            },
            ...
            onchange: function() {
                ...
                //                 .appendField(Educablocks3.locales.getKey('LANG_TEXT_APPEND_TO'))
                //                 .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                //                 .appendField(Educablocks3.locales.getKey('LANG_TEXT_APPEND_APPENDTEXT'));
                //             this.setInputsInline(true);
                //         }catch(e){}
                //         this.last_variables=Blockly.Variables.allVariables();
                //     }
        ...
        Blockly.Arduino.text_equalsIgnoreCase = function() {
            ...
            var a = Educablocks3.findPinMode(string1);
            code += a['code'];
            string1 = a['pin'];

            a = Educablocks3.findPinMode(string2);
            code += a['code'];
            string2 = a['pin'];
        ...
        Blockly.Blocks.text_equalsIgnoreCase = {
            ...
            init: function() {
                ...
                this.appendValueInput('STRING1')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_IS'));

                this.appendValueInput('STRING2')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_EQUAL'))
                    .setAlign(Blockly.ALIGN_RIGHT);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_QUESTION'));

                this.setInputsInline(true);

                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_EQUALSIGNORECASE_TOOLTIP'));
            }
        };
        ...
        Blockly.Blocks.text_join = {
            ...
            init: function() {
                ...
                this.appendValueInput('ADD0')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_JOIN_Field_CREATEWITH'));
                this.appendValueInput('ADD1');
                this.setOutput(true, String);
                this.setMutator(new Blockly.Mutator(['text_create_join_item']));
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_JOIN_TOOLTIP'));
                this.itemCount_ = 2;
            },
            mutationToDom: function() {
                var container = document.createElement('mutation');
            ...
            domToMutation: function(xmlElement) {
                ...
                for (x = 0; x < this.itemCount_; x++) {
                    ...
                    if (x === 0) {
                        input.appendField(Educablocks3.locales.getKey('LANG_TEXT_JOIN_Field_CREATEWITH'));
                    }
                }
                if (this.itemCount_ === 0) {
        ...
        Blockly.Blocks.text_create_join_container = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_Field_JOIN'));
                this.appendStatementInput('STACK');
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.text_create_join_item = {
            ...
            init: function() {
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_Field_ITEM'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TOOLTIP'));
                this.contextMenu = false;
            }
        };
        ...
        Blockly.Blocks.text_create_join_container = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_TITLE_JOIN'));
                this.appendStatementInput('STACK');
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_TOOLTIP'));
                this.contextMenu = false;
            }
        ...
        Blockly.Blocks.text_create_join_item = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_TEXT);
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TITLE_ITEM'));
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_CREATE_JOIN_ITEM_TOOLTIP'));
                this.contextMenu = false;
        ...
        Blockly.Blocks.text_length = {
            ...
            init: function() {
                ...
                this.appendValueInput('VALUE')
                    ...
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_LENGTH_INPUT_LENGTH'));
                this.setOutput(true, Number);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_LENGTH_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.text_substring = function() {
            ...
            a = Educablocks3.findPinMode(from);
            code += a['code'];
            from = a['pin'];

            a = Educablocks3.findPinMode(to);
            code += a['code'];
            to = a['pin'];
        ...
        Blockly.Blocks.text_substring = {
            ...
            init: function() {
                ...
                this.appendValueInput('STRING1')
                    // .setCheck(String)
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_SUBSTRING'));

                this.appendValueInput('FROM')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_SUBSTRING_FROM'))
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT);

                this.appendValueInput('TO')
                    .appendField(Educablocks3.locales.getKey('LANG_TEXT_SUBSTRING_TO'))
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT);
                // this.appendDummyInput()
                //     .appendField(Educablocks3.locales.getKey('LANG_TEXT_SUBSTRING_QUESTION'));

                this.setInputsInline(true);

                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_TEXT_SUBSTRING_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.variables_get = function() {
            ...
            if (Educablocks3.variables[this.getFieldValue('VAR')] !== undefined) {
                this.var_type = Educablocks3.variables[this.getFieldValue('VAR')][0];
            }
            return [varName, Blockly.Arduino.ORDER_ATOMIC];
        };
        Blockly.Blocks.variables_get = {
            // Variable setter.
            category: Educablocks3.locales.getKey('LANG_CATEGORY_VARIABLES'), // Variables are handled specially.
            helpUrl: Educablocks3.URL_VAR,
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendDummyInput('DUMMY').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GET'))
                    // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                    .appendField(new Blockly.FieldVariable(' '), 'VAR');
                this.setOutput(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_GET_TOOLTIP'));
            },
            getVariables: function() {
                var variables = Blockly.Variables.allVariables();
                var dropdown = [];
            ...
            onchange: function() {
                ...
                //         }catch(e){}
                //         this.appendDummyInput('DUMMY')
                //             .appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GET'))
                //             .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR');
                //         this.setFieldValue(this.last_variable, 'VAR');
                //         this.last_variables=Blockly.Variables.allVariables();
                //     }
        ...
        Blockly.Arduino.variables_global = function() {
            ...
            var a = Educablocks3.findPinMode(varValue);
            ...
            if (varValue.search('"') >= 0 || varValue.search('substring\\(') >= 0) {
                ...
                varType = Educablocks3.variables[varValue][0];
                Blockly.Arduino.definitions_['declare_var' + varName] = varType + ' ' + varName + ';\n';
                Blockly.Arduino.setups_['define_var' + varName] = varName + '=' + varValue + ';\n';
            ...
            Educablocks3.variables[varName] = [varType, 'global'];
            Educablocks3.variables['analogRead(' + varName + ')'] = [varType, 'global'];
            Educablocks3.variables['digitalRead(' + varName + ')'] = [varType, 'global'];
        ...
        Blockly.Blocks.variables_global = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL')).appendField(new Blockly.FieldTextInput(''), 'VAR').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL_TOOLTIP'));
            },
            getVars: function() {
                return [this.getFieldValue('VAR')];
            },
        ...
        Blockly.Blocks.variables_global_type = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').
                appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL')).
                appendField(new Blockly.FieldTextInput(''), 'VAR').
                appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL_TYPE')).
                appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_STRING'), 'String'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_INTEGER'), 'int'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_INTEGER_LONG'), 'long'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_BYTE'), 'byte'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_FLOAT'), 'float']
                ]), "VAR_TYPE").
                appendField(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_GLOBAL_TOOLTIP'));
        ...
        Blockly.Arduino.variables_local = function() {
            ...
            Educablocks3.variables[varName] = [varType, 'local'];
            Educablocks3.variables['analogRead(' + varName + ')'] = [varType, 'local'];
            Educablocks3.variables['digitalRead(' + varName + ')'] = [varType, 'local'];
        ...
        Blockly.Blocks.variables_local = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_LOCAL')).appendField(new Blockly.FieldTextInput(''), 'VAR').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_LOCAL_EQUALS'));
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_LOCAL_TOOLTIP'));
            },
            getVars: function() {
                return [this.getFieldValue('VAR')];
            },
        ...
        Blockly.Blocks.variables_local_type = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').
                appendField(Educablocks3.locales.getKey('LANG_VARIABLES_LOCAL')).
                appendField(new Blockly.FieldTextInput(''), 'VAR').
                appendField(Educablocks3.locales.getKey('LANG_VARIABLES_LOCAL_TYPE')).
                appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_STRING'), 'String'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_INTEGER'), 'int'],
                    [Educablocks3.locales.getKey('LANG_VARIABLES_TYPE_INTEGER_LONG'), 'long'],
        ...
        Blockly.Blocks.variables_set = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_VARIABLES);
                this.appendValueInput('VALUE').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_SET'))
                    // .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                    .appendField(new Blockly.FieldVariable(' '), 'VAR').appendField(Educablocks3.locales.getKey('LANG_VARIABLES_SET_AS')).setAlign(Blockly.ALIGN_RIGHT);
                this.setInputsInline(false);
                this.setPreviousStatement(true);
                this.setNextStatement(true);
                this.setTooltip(Educablocks3.locales.getKey('LANG_VARIABLES_SET_TOOLTIP'));
            },
            getVariables: function() {
                var variables = Blockly.Variables.allVariables();
                var dropdown = [];
            ...
            onchange: function() {
                ...
                //             this.removeInput('VALUE');
                //             this.appendValueInput('VALUE')
                //                 .appendField(Educablocks3.locales.getKey('LANG_VARIABLES_SET'))
                //                 .appendField(new Blockly.FieldDropdown(this.getVariables()), 'VAR')
                //                 .appendField(Educablocks3.locales.getKey('LANG_VARIABLES_SET_AS'))
                //                 .setAlign(Blockly.ALIGN_RIGHT);
                //             this.setInputsInline(false);
                //             this.setFieldValue(this.last_variable, 'VAR');
                //         }catch(e){}
...
Blockly.Blocks.salidas_rele = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_RELE')).appendField(new Blockly.FieldImage('img/blocks/educablocks/26.png', 208 * options.zoom, 140 * options.zoom)).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_rele_PIN')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.appendDummyInput().appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LED_STATE')).setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_RELE_ON') || 'ON', 'HIGH'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_RELE_OFF') || 'OFF', 'LOW']
                ]), 'STAT');
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_rele_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.ENTRADAS_piezo_buzzer = function() {
            ...
            a = Educablocks3.findPinMode(delay_time);
            code += a['code'];
            delay_time = a['pin'];
        ...
        Blockly.Blocks.ENTRADAS_piezo_buzzer = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SALIDAS'),
            tags: ['buzzer'],
            helpUrl: Educablocks3.URL_BUZZER,
            /**
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput('PIN')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER'))
                    .appendField(new Blockly.FieldImage('img/blocks/educablocks/15.png', 60 * options.zoom, 110 * options.zoom))
                    .setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN10') || '10', '10'],
                ...
                this.appendDummyInput()
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_TONE'))
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_DO') || 'DO', '261'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_RE') || 'RE', '293'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_MI') || 'MI', '329'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_FA') || 'FA', '349'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_SOL') || 'SOL', '392'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_LA') || 'LA', '440'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_SI') || 'SI', '494']
                    ]), 'STAT'); //523
                this.appendDummyInput()
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_DURATION')).appendField(new Blockly.FieldTextInput('1000'), 'DURA')
                this.setInputsInline(true);
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP'));
            }
        };
        ...
        Blockly.Arduino.ENTRADAS_piezo_buzzerav = function() {
            ...
            a = Educablocks3.findPinMode(Buzztone);
            code += a['code'];
            Buzztone = a['pin'];
        ...
        Blockly.Blocks.ENTRADAS_piezo_buzzerav = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_ENTRADASanterior'),
            tags: ['buzzer'],
            helpUrl: Educablocks3.URL_BUZZER,
            /**
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_ENTRADAS);
                this.appendValueInput('PIN')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERAV'))
                    .appendField(new Blockly.FieldImage('img/blocks/educablocks/15.png', 208 * options.zoom, 140 * options.zoom))
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERAV_PIN'));
                this.appendValueInput('TONE', Number)
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERAV_TONE'));

                this.appendValueInput('DURA', Number)
                    .setCheck(Number)
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERAV_DURATION'));

                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP'));
            }
        };



            Blockly.Arduino.ENTRADAS_piezo_buzzerno = function() {
            var dropdown_pin = this.getFieldValue('NPIN');
            ...
            code += JST['ENTRADAS_piezo_buzzerno']({
                'dropdown_pin': dropdown_pin
            });
        ...
        Blockly.Blocks.ENTRADAS_piezo_buzzerno = {
            ...
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput('PIN')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZERNO'))
                .setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_PIEZO_BUZZER_PIN')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN13') || '13', '13'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN12') || '12', '12'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN11') || '11', '11'],
        ...
        Blockly.Arduino.SALIDAS_ledrgb = function() {
            ...
            var code = '';
            var a = Educablocks3.findPinMode(dropdown_pinrojo);
            code += a['code'];
            dropdown_pinrojo = a['pin'];

            var a = Educablocks3.findPinMode(dropdown_pinverde);
            code += a['code'];
            dropdown_pinverde = a['pin'];

            var a = Educablocks3.findPinMode(dropdown_pinazul);
            code += a['code'];
            dropdown_pinazul = a['pin'];


            if (Educablocks3.isVariable(dropdown_pinrojo)) {
        ...
        Blockly.Blocks.SALIDAS_ledrgb = {
            category: Educablocks3.locales.getKey('LANG_CATEGORY_SALIDAS'),
            tags: ['ledrgb'],
            helpUrl: Educablocks3.URL_ledrgb,
            /**
             * LED RGB
             */
            init: function() {
                this.setColour(Educablocks3.LANG_COLOUR_SALIDAS);
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB'))
                    .appendField(new Blockly.FieldImage('img/blocks/07.png', 148 * options.zoom, 100 * options.zoom));
                this.appendDummyInput('PINROJO').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_PINROJO')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN9') || '9', '9'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN6') || '6', '6'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN5') || '5', '5'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3']
                ]), 'NPIN1');
                this.appendDummyInput('PINVERDE').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_PINVERDE')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN9') || '6', '6'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN6') || '9', '9'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN5') || '5', '5'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3']
                ]), 'NPIN2');
                this.appendDummyInput('PINAZUL').setAlign(Blockly.ALIGN_RIGHT).appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_PINAZUL')).appendField(new Blockly.FieldDropdown([
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN9') || '5', '5'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN6') || '9', '9'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN5') || '6', '6'],
                    [Educablocks3.locales.getKey('LANG_SALIDAS_LED_PIN3') || '3', '3']
                ]), 'NPIN3');
                this.appendDummyInput('')
                    .appendField(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_COLOR'))
                    .appendField(new Blockly.FieldDropdown([
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_ROJO') || 'ROJO', '255, 0, 0'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_VERDE') || 'VERDE', '0, 255, 0'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_AZUL') || 'AZUL', '0, 0, 255'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_AMARILLO') || 'AMARILLO', '255, 255, 0'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_VIOLETA') || 'VIOLETA', '153, 51, 255'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_NARANJA') || 'NARANJA', '255, 128, 0'],
                        [Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_APAGADO') || 'APAGADO', '0, 0, 0'],
                    ]), 'STAT') //523
                ...
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setTooltip(Educablocks3.locales.getKey('LANG_SALIDAS_LEDRGB_TOOLTIP'));
            }
        };
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        window.Educablocks3 = Educablocks3;
    }
}));
