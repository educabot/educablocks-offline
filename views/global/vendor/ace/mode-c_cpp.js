define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        u = function() {
            var e = "break|case|continue|default|do|else|for|goto|if|elif|while|return|switch|while|catch|operator|try|throw|using",
                t = "HIGH|LOW|OUTPUT|INPUT|INPUT_PULLUP|asm|__asm__|auto|bool|_Bool|char|_Complex|double|enum|float|_Imaginary|int|NULL|true|false|TRUE|FALSE|nullptr|long|short|signed|struct|typedef|union|unsigned|void|class|wchar_t|template|char16_t|char32_t",
                ...
                r = "pinMode|digitalWrite|digitalRead|analogWrite|delay|analogRead|pinMode|and|and_eq|bitand|bitor|compl|not|not_eq|or|or_eq|typeid|xor|xor_eqconst_cast|dynamic_cast|reinterpret_cast|static_cast|sizeof|namespace",
                s = "attach|read|write|Serial|print|println|tone|matriz|Servo",
