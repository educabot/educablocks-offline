...
hljs.registerLanguage("cpp", function(t) {
    var e = {
        ...
        a = t.IR + "\\s*\\(",
        c = {
            keyword: " HIGH LOW OUTPUT INPUT INPUT_PULLUP int float while private char catch export virtual operator sizeof dynamic_cast|10 typedef const_cast|10 const struct for static_cast|10 union namespace unsigned long volatile static protected bool template mutable if public friend do goto auto void enum else break extern using class asm case typeid short reinterpret_cast|10 default double register explicit signed typename try this switch continue inline delete alignof constexpr decltype noexcept static_assert thread_local restrict _Bool complex _Complex _Imaginary atomic_bool atomic_char atomic_schar atomic_uchar atomic_short atomic_ushort atomic_int atomic_uint atomic_long atomic_ulong atomic_llong atomic_ullong",
            ...
            literal: "Servo shutdown setIntensity println read readString clearDisplay LedContro writeString setBacklight tone clear setCursor print init backlight write attach true false nullptr NULL pinMode digitalWrite digitalRead analogWrite delay analogRead pinMode"
        };
    return {
