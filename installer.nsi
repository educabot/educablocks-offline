...
!define setup "educablocks-installer.exe"

; change this to wherever the files to be packaged reside
!define srcdir ".\dist\educablocks-offline-win32-ia32"

!define company "Educabot"

!define prodname "Educablocks"
!define exec "educablocks-offline.exe"

; optional stuff

; Set the text which prompts the user to enter the installation directory
 DirText "Educablocks Offline."
...
!endif
  CreateShortCut "$DESKTOP\Educablocks Offline.lnk" "$INSTDIR\${exec}"
...
Section "Uninstall"
  ...
  Delete "$DESKTOP\Educablocks Offline.lnk"
